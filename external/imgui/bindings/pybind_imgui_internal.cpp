...
void py_init_module_imgui_internal(nb::module_ &m)
{
    ...
    m.def("im_min", [](const ImVec2 &lhs, const ImVec2 &rhs) -> ImVec2
          {
            ...
            return ImMin_adapt_force_lambda(lhs, rhs); }, nb::arg("lhs"), nb::arg("rhs"), "(private API)");

    m.def("im_max", [](const ImVec2 &lhs, const ImVec2 &rhs) -> ImVec2
          {
            ...
            return ImMax_adapt_force_lambda(lhs, rhs); }, nb::arg("lhs"), nb::arg("rhs"), "(private API)");

    m.def("im_clamp", [](const ImVec2 &v, const ImVec2 &mn, const ImVec2 &mx) -> ImVec2
          {
            ...
            return ImClamp_adapt_force_lambda(v, mn, mx); }, nb::arg("v"), nb::arg("mn"), nb::arg("mx"), "(private API)");

    m.def("im_lerp", [](const ImVec2 &a, const ImVec2 &b, float t) -> ImVec2
          {
            ...
            return ImLerp_adapt_force_lambda(a, b, t); }, nb::arg("a"), nb::arg("b"), nb::arg("t"), "(private API)");

    m.def("im_lerp", [](const ImVec2 &a, const ImVec2 &b, const ImVec2 &t) -> ImVec2
          {
    ...
    m.def("im_lerp", [](const ImVec4 &a, const ImVec4 &b, float t) -> ImVec4
          {
    ...
    m.def("im_triangle_barycentric_coords", [](const ImVec2 &a, const ImVec2 &b, const ImVec2 &c, const ImVec2 &p, float out_u, float out_v, float out_w) -> std::tuple<float, float, float>
          {
            ...
            return ImTriangleBarycentricCoords_adapt_modifiable_immutable_to_return(a, b, c, p, out_u, out_v, out_w); }, nb::arg("a"), nb::arg("b"), nb::arg("c"), nb::arg("p"), nb::arg("out_u"), nb::arg("out_v"), nb::arg("out_w"));
    ...
    auto pyClassImVec2ih =
        nb::class_<ImVec2ih>(m, "ImVec2ih", "Helper: ImVec2ih (2D vector, half-size integer, for long-term packed storage)")
            .def_rw("x", &ImVec2ih::x, "")
            .def_rw("y", &ImVec2ih::y, "")
            .def(nb::init<>())
    ...
    auto pyClassImRect =
        nb::class_<ImRect>(m, "ImRect", " Helper: ImRect (2D axis aligned bounding-box)\n NB: we can't rely on ImVec2 math operators being available here!")
            ...
            .def("contains", [](const ImRect &self, const ImVec2 &p) -> bool
                 {
                ...
                return Contains_adapt_force_lambda(p); }, nb::arg("p"), "(private API)")
            .def("contains", [](const ImRect &self, const ImRect &r) -> bool
                 {
                ...
                return Contains_adapt_force_lambda(r); }, nb::arg("r"), "(private API)")
            .def("contains_with_pad", &ImRect::ContainsWithPad, nb::arg("p"), nb::arg("pad"), "(private API)")
            .def("overlaps", &ImRect::Overlaps, nb::arg("r"), "(private API)")
            .def("add", nb::overload_cast<const ImVec2 &>(&ImRect::Add), nb::arg("p"), "(private API)")
            .def("add", nb::overload_cast<const ImRect &>(&ImRect::Add), nb::arg("r"), "(private API)")
            .def("expand", nb::overload_cast<const float>(&ImRect::Expand), nb::arg("amount"), "(private API)")
            .def("expand", nb::overload_cast<const ImVec2 &>(&ImRect::Expand), nb::arg("amount"), "(private API)")
            .def("translate", &ImRect::Translate, nb::arg("d"), "(private API)")
            .def("translate_x", &ImRect::TranslateX, nb::arg("dx"), "(private API)")
            .def("translate_y", &ImRect::TranslateY, nb::arg("dy"), "(private API)")
            .def("clip_with", &ImRect::ClipWith, nb::arg("r"), "(private API)\n\n Simple version, may lead to an inverted rectangle, which is fine for Contains/Overlaps test but not for display.")
            .def("clip_with_full", &ImRect::ClipWithFull, nb::arg("r"), "(private API)\n\n Full version, ensure both points are fully clipped.")
            .def("floor", &ImRect::Floor, "(private API)")
            .def("is_inverted", &ImRect::IsInverted, "(private API)")
            .def("to_vec4", &ImRect::ToVec4, "(private API)")
    ...
    auto pyClassImBitVector =
        nb::class_<ImBitVector>(m, "ImBitVector", " Helper: ImBitVector\n Store 1-bit per value.")
            ...
            if (Storage.has_value())
                ...
                r->Storage = ImVector<ImU32>(); }, nb::arg("storage") = nb::none())
            .def_rw("storage", &ImBitVector::Storage, "")
            .def("create", &ImBitVector::Create, nb::arg("sz"), "(private API)")
            .def("clear", &ImBitVector::Clear, "(private API)")
            .def("test_bit", &ImBitVector::TestBit, nb::arg("n"), "(private API)")
            .def("set_bit", &ImBitVector::SetBit, nb::arg("n"), "(private API)")
            .def("clear_bit", &ImBitVector::ClearBit, nb::arg("n"), "(private API)");

    auto pyClassImGuiTextIndex =
        nb::class_<ImGuiTextIndex>(m, "TextIndex", " Helper: ImGuiTextIndex\n Maintain a line index for a text buffer. This is a strong candidate to be moved into the public API.")
            ...
            r->EndOffset = EndOffset; }, nb::arg("line_offsets") = nb::none(), nb::arg("end_offset") = 0)
            ...
            .def("clear", &ImGuiTextIndex::clear, "(private API)")
            .def("size", &ImGuiTextIndex::size, "(private API)")
            .def("get_line_begin", &ImGuiTextIndex::get_line_begin, nb::arg("base"), nb::arg("n"), "(private API)", nb::rv_policy::reference)
            .def("get_line_end", &ImGuiTextIndex::get_line_end, nb::arg("base"), nb::arg("n"), "(private API)", nb::rv_policy::reference)
            .def("append", &ImGuiTextIndex::append, nb::arg("base"), nb::arg("old_size"), nb::arg("new_size"), "(private API)");
    ...
    auto pyClassImDrawListSharedData =
        nb::class_<ImDrawListSharedData>(m, "ImDrawListSharedData", " Data shared between all ImDrawList instances\n You may want to create your own instance of this if you want to use ImDrawList completely without ImGui. In that case, watch out for future changes to this structure.")
            ...
            .def_prop_ro("circle_segment_counts", [](ImDrawListSharedData &self) -> nb::ndarray<ImU8, nb::numpy, nb::shape<64>, nb::c_contig>
                         { return self.CircleSegmentCounts; }, "Precomputed segment count for given radius before we calculate it dynamically (to avoid calculation overhead)")
            .def_ro("tex_uv_lines", &ImDrawListSharedData::TexUvLines, "UV of anti-aliased lines in the atlas")
            .def(nb::init<>())
            .def("set_circle_tessellation_max_error", &ImDrawListSharedData::SetCircleTessellationMaxError, nb::arg("max_error"), "(private API)");

    auto pyClassImDrawDataBuilder =
        nb::class_<ImDrawDataBuilder>(m, "ImDrawDataBuilder", "")
            .def_rw("layer_data1", &ImDrawDataBuilder::LayerData1, "")
            .def(nb::init<>());

    auto pyClassImGuiDataVarInfo =
        nb::class_<ImGuiDataVarInfo>(m, "DataVarInfo", "")
            ...
            r->Count = Count;
            r->Offset = Offset; }, nb::arg("type") = nb::none(), nb::arg("count") = ImU32(), nb::arg("offset") = ImU32())
            ...
            .def("get_var_ptr", &ImGuiDataVarInfo::GetVarPtr, nb::arg("parent"), "(private API)", nb::rv_policy::reference);

    auto pyClassImGuiDataTypeStorage =
        nb::class_<ImGuiDataTypeStorage>(m, "DataTypeStorage", "")
            .def(nb::init<>()) // implicit default constructor
            .def_prop_ro("data", [](ImGuiDataTypeStorage &self) -> nb::ndarray<ImU8, nb::numpy, nb::shape<8>, nb::c_contig>
                         { return self.Data; }, "Opaque storage to fit any data up to ImGuiDataType_COUNT");

    auto pyClassImGuiDataTypeInfo =
        nb::class_<ImGuiDataTypeInfo>(m, "DataTypeInfo", "Type information associated to one ImGuiDataType. Retrieve with DataTypeGetInfo().")
            .def("__init__", [](ImGuiDataTypeInfo *self, size_t Size = size_t())
                 {
            new (self) ImGuiDataTypeInfo();  // placement new
            auto r = self;
            r->Size = Size; }, nb::arg("size") = size_t())
    ...
    auto pyClassImGuiColorMod =
        nb::class_<ImGuiColorMod>(m, "ColorMod", "Stacked color modifier, backup of modified data so we can restore it")
            ...
            if (BackupValue.has_value())
                ...
                r->BackupValue = ImVec4(); }, nb::arg("col") = nb::none(), nb::arg("backup_value") = nb::none())
            .def_rw("col", &ImGuiColorMod::Col, "")
            .def_rw("backup_value", &ImGuiColorMod::BackupValue, "");

    auto pyClassImGuiStyleMod =
        nb::class_<ImGuiStyleMod>(m, "StyleMod", "Stacked style modifier, backup of modified data so we can restore it. Data type inferred from the variable.")
    ...
    auto pyClassImGuiComboPreviewData =
        nb::class_<ImGuiComboPreviewData>(m, "ComboPreviewData", "Storage data for BeginComboPreview()/EndComboPreview()")
    ...
    auto pyClassImGuiGroupData =
        nb::class_<ImGuiGroupData>(m, "GroupData", "Stacked storage data for BeginGroup()/EndGroup()")
    ...
    auto pyClassImGuiMenuColumns =
        nb::class_<ImGuiMenuColumns>(m, "MenuColumns", "Simple column measurement, currently used for MenuItem() only.. This is very short-sighted/throw-away code and NOT a generic helper.")
            ...
            .def_prop_ro("widths", [](ImGuiMenuColumns &self) -> nb::ndarray<ImU16, nb::numpy, nb::shape<4>, nb::c_contig>
                         { return self.Widths; }, "Width of:   Icon, Label, Shortcut, Mark  (accumulators for current frame)")
            .def(nb::init<>())
            .def("update", &ImGuiMenuColumns::Update, nb::arg("spacing"), nb::arg("window_reappearing"), "(private API)")
            .def("decl_columns", &ImGuiMenuColumns::DeclColumns, nb::arg("w_icon"), nb::arg("w_label"), nb::arg("w_shortcut"), nb::arg("w_mark"), "(private API)")
            .def("calc_next_total_width", &ImGuiMenuColumns::CalcNextTotalWidth, nb::arg("update_offsets"), "(private API)");

    auto pyClassImGuiInputTextDeactivatedState =
        nb::class_<ImGuiInputTextDeactivatedState>(m, "InputTextDeactivatedState", "Internal temporary state for deactivating InputText() instances.")
    ...
    auto pyClassImGuiInputTextState =
        nb::class_<ImGuiInputTextState>(m, "InputTextState", " Internal state of the currently focused/edited text input box\n For a given item ID, access with ImGui::GetInputTextState()")
    ...
    auto pyClassImGuiNextWindowData =
        nb::class_<ImGuiNextWindowData>(m, "NextWindowData", "Storage for SetNexWindow** functions")
    ...
    auto pyClassImGuiNextItemData =
        nb::class_<ImGuiNextItemData>(m, "NextItemData", "")
    ...
    auto pyClassImGuiLastItemData =
        nb::class_<ImGuiLastItemData>(m, "LastItemData", "Status storage for the last submitted item")
    ...
    auto pyClassImGuiTreeNodeStackData =
        nb::class_<ImGuiTreeNodeStackData>(m, "TreeNodeStackData", " Store data emitted by TreeNode() for usage by TreePop()\n - To implement ImGuiTreeNodeFlags_NavLeftJumpsBackHere: store the minimum amount of data\n   which we can't infer in TreePop(), to perform the equivalent of NavApplyItemToResult().\n   Only stored when the node is a potential candidate for landing on a Left arrow jump.")
            ...
            if (NavRect.has_value())
                ...
                r->NavRect = ImRect(); }, nb::arg("id_") = ImGuiID(), nb::arg("tree_flags") = ImGuiTreeNodeFlags(), nb::arg("item_flags") = ImGuiItemFlags(), nb::arg("nav_rect") = nb::none())
    ...
    auto pyClassImGuiErrorRecoveryState =
        nb::class_<ImGuiErrorRecoveryState>(m, "ErrorRecoveryState", "sizeof() = 20")
    ...
    auto pyClassImGuiWindowStackData =
        nb::class_<ImGuiWindowStackData>(m, "WindowStackData", "Data saved for each window pushed into the stack")
            ...
            r->DisabledOverrideReenable = DisabledOverrideReenable; }, nb::arg("parent_last_item_data_backup") = nb::none(), nb::arg("stack_sizes_in_begin") = nb::none(), nb::arg("disabled_override_reenable") = bool())
    ...
    auto pyClassImGuiShrinkWidthItem =
        nb::class_<ImGuiShrinkWidthItem>(m, "ShrinkWidthItem", "")
            ...
            r->Index = Index;
            r->Width = Width;
            r->InitialWidth = InitialWidth; }, nb::arg("index") = int(), nb::arg("width") = float(), nb::arg("initial_width") = float())
    ...
    auto pyClassImGuiPtrOrIndex =
        nb::class_<ImGuiPtrOrIndex>(m, "PtrOrIndex", "")
    ...
    auto pyClassImGuiPopupData =
        nb::class_<ImGuiPopupData>(m, "PopupData", "Storage for popup stacks (g.OpenPopupStack and g.BeginPopupStack)")
    ...
    auto pyClassImGuiInputEventMousePos =
        nb::class_<ImGuiInputEventMousePos>(m, "InputEventMousePos", "")
            ...
            if (MouseSource.has_value())
                ...
                r->MouseSource = ImGuiMouseSource(); }, nb::arg("pos_x") = float(), nb::arg("pos_y") = float(), nb::arg("mouse_source") = nb::none())
    ...
    auto pyClassImGuiInputEventMouseWheel =
        nb::class_<ImGuiInputEventMouseWheel>(m, "InputEventMouseWheel", "")
            ...
            if (MouseSource.has_value())
                ...
                r->MouseSource = ImGuiMouseSource(); }, nb::arg("wheel_x") = float(), nb::arg("wheel_y") = float(), nb::arg("mouse_source") = nb::none())
    ...
    auto pyClassImGuiInputEventMouseButton =
        nb::class_<ImGuiInputEventMouseButton>(m, "InputEventMouseButton", "")
            ...
            if (MouseSource.has_value())
                ...
                r->MouseSource = ImGuiMouseSource(); }, nb::arg("button") = int(), nb::arg("down") = bool(), nb::arg("mouse_source") = nb::none())
    ...
    auto pyClassImGuiInputEventMouseViewport =
        nb::class_<ImGuiInputEventMouseViewport>(m, "InputEventMouseViewport", "")
            ...
            auto r = self;
            r->HoveredViewportID = HoveredViewportID; }, nb::arg("hovered_viewport_id") = ImGuiID())
            .def_rw("hovered_viewport_id", &ImGuiInputEventMouseViewport::HoveredViewportID, "");

    auto pyClassImGuiInputEventKey =
        nb::class_<ImGuiInputEventKey>(m, "InputEventKey", "")
            ...
            r->Key = Key;
            r->Down = Down;
            r->AnalogValue = AnalogValue; }, nb::arg("key") = ImGuiKey(), nb::arg("down") = bool(), nb::arg("analog_value") = float())
    ...
    auto pyClassImGuiKeyRoutingData =
        nb::class_<ImGuiKeyRoutingData>(m, "KeyRoutingData", "Routing table entry (sizeof() == 16 bytes)")
    ...
    auto pyClassImGuiKeyRoutingTable =
        nb::class_<ImGuiKeyRoutingTable>(m, "KeyRoutingTable", " Routing table: maintain a desired owner for each possible key-chord (key + mods), and setup owner in NewFrame() when mods are matching.\n Stored in main context (1 instance)")
    ...
    auto pyClassImGuiKeyOwnerData =
        nb::class_<ImGuiKeyOwnerData>(m, "KeyOwnerData", " This extends ImGuiKeyData but only for named keys (legacy keys don't support the new features)\n Stored in main context (1 per named key). In the future it might be merged into ImGuiKeyData.")
    ...
    auto pyClassImGuiListClipperRange =
        nb::class_<ImGuiListClipperRange>(m, "ListClipperRange", "Note that Max is exclusive, so perhaps should be using a Begin/End convention.")
            ...
            r->PosToIndexOffsetMax = PosToIndexOffsetMax; }, nb::arg("min") = int(), nb::arg("max") = int(), nb::arg("pos_to_index_convert") = bool(), nb::arg("pos_to_index_offset_min") = ImS8(), nb::arg("pos_to_index_offset_max") = ImS8())
            ...
            .def_static("from_indices", &ImGuiListClipperRange::FromIndices, nb::arg("min"), nb::arg("max"), "(private API)")
            .def_static("from_positions", &ImGuiListClipperRange::FromPositions, nb::arg("y1"), nb::arg("y2"), nb::arg("off_min"), nb::arg("off_max"), "(private API)");

    auto pyClassImGuiListClipperData =
        nb::class_<ImGuiListClipperData>(m, "ListClipperData", "Temporary clipper data, buffers shared/reused between instances")
    ...
    auto pyClassImGuiNavItemData =
        nb::class_<ImGuiNavItemData>(m, "NavItemData", "Storage for navigation query/results")
    ...
    auto pyClassImGuiFocusScopeData =
        nb::class_<ImGuiFocusScopeData>(m, "FocusScopeData", "Storage for PushFocusScope(), g.FocusScopeStack[], g.NavFocusRoute[]")
            ...
            auto r = self;
            r->ID = ID;
            r->WindowID = WindowID; }, nb::arg("id_") = ImGuiID(), nb::arg("window_id") = ImGuiID())
    ...
    auto pyClassImGuiTypingSelectRequest =
        nb::class_<ImGuiTypingSelectRequest>(m, "TypingSelectRequest", "Returned by GetTypingSelectRequest(), designed to eventually be public.")
            ...
            r->SingleCharSize = SingleCharSize; }, nb::arg("flags") = ImGuiTypingSelectFlags(), nb::arg("search_buffer_len") = int(), nb::arg("select_request") = bool(), nb::arg("single_char_mode") = bool(), nb::arg("single_char_size") = ImS8())
    ...
    auto pyClassImGuiTypingSelectState =
        nb::class_<ImGuiTypingSelectState>(m, "TypingSelectState", "Storage for GetTypingSelectRequest()")
    ...
    auto pyClassImGuiOldColumnData =
        nb::class_<ImGuiOldColumnData>(m, "OldColumnData", "")
    ...
    auto pyClassImGuiOldColumns =
        nb::class_<ImGuiOldColumns>(m, "OldColumns", "")
    ...
    auto pyClassImGuiBoxSelectState =
        nb::class_<ImGuiBoxSelectState>(m, "BoxSelectState", "")
    ...
    auto pyClassImGuiMultiSelectTempData =
        nb::class_<ImGuiMultiSelectTempData>(m, "MultiSelectTempData", "Temporary storage for multi-select")
    ...
    auto pyClassImGuiMultiSelectState =
        nb::class_<ImGuiMultiSelectState>(m, "MultiSelectState", "Persistent storage for multi-select (as long as selection is alive)")
    ...
    auto pyClassImGuiDockNode =
        nb::class_<ImGuiDockNode>(m, "DockNode", "sizeof() 156~192")
    ...
    auto pyClassImGuiWindowDockStyle =
        nb::class_<ImGuiWindowDockStyle>(m, "WindowDockStyle", "We don't store style.Alpha: dock_node->LastBgColor embeds it and otherwise it would only affect the docking tab, which intuitively I would say we don't want to.")
            .def(nb::init<>()) // implicit default constructor
        ;

    auto pyClassImGuiDockContext =
        nb::class_<ImGuiDockContext>(m, "DockContext", "")
    ...
    auto pyClassImGuiViewportP =
        nb::class_<ImGuiViewportP>(m, "ViewportP", " ImGuiViewport Private/Internals fields (cardinal sin: we are using inheritance!)\n Every instance of ImGuiViewport is in fact a ImGuiViewportP.")
            ...
            .def_prop_ro("bg_fg_draw_lists_last_frame", [](ImGuiViewportP &self) -> nb::ndarray<int, nb::numpy, nb::shape<2>, nb::c_contig>
                         { return self.BgFgDrawListsLastFrame; }, "Last frame number the background (0) and foreground (1) draw lists were used")
            ...
            .def(nb::init<>())
            .def("clear_request_flags", &ImGuiViewportP::ClearRequestFlags, "(private API)")
            .def("calc_work_rect_pos", &ImGuiViewportP::CalcWorkRectPos, nb::arg("inset_min"), "(private API)")
            .def("calc_work_rect_size", &ImGuiViewportP::CalcWorkRectSize, nb::arg("inset_min"), nb::arg("inset_max"), "(private API)")
            .def("update_work_rect", &ImGuiViewportP::UpdateWorkRect, "(private API)\n\n Update public fields")
            .def("get_main_rect", &ImGuiViewportP::GetMainRect, "(private API)")
            .def("get_work_rect", &ImGuiViewportP::GetWorkRect, "(private API)")
            .def("get_build_work_rect", &ImGuiViewportP::GetBuildWorkRect, "(private API)");

    auto pyClassImGuiWindowSettings =
        nb::class_<ImGuiWindowSettings>(m, "WindowSettings", " Windows data saved in imgui.ini file\n Because we never destroy or rename ImGuiWindowSettings, we can store the names in a separate buffer easily.\n (this is designed to be stored in a ImChunkStream buffer, with the variable-length Name following our structure)")
    ...
    auto pyClassImGuiSettingsHandler =
        nb::class_<ImGuiSettingsHandler>(m, "SettingsHandler", "")
    ...
    auto pyClassImGuiDebugAllocEntry =
        nb::class_<ImGuiDebugAllocEntry>(m, "DebugAllocEntry", "")
            ...
            r->FreeCount = FreeCount; }, nb::arg("frame_count") = int(), nb::arg("alloc_count") = ImS16(), nb::arg("free_count") = ImS16())
    ...
    auto pyClassImGuiDebugAllocInfo =
        nb::class_<ImGuiDebugAllocInfo>(m, "DebugAllocInfo", "")
    ...
    auto pyClassImGuiMetricsConfig =
        nb::class_<ImGuiMetricsConfig>(m, "MetricsConfig", "")
    ...
    auto pyClassImGuiStackLevelInfo =
        nb::class_<ImGuiStackLevelInfo>(m, "StackLevelInfo", "")
    ...
    auto pyClassImGuiIDStackTool =
        nb::class_<ImGuiIDStackTool>(m, "IDStackTool", "State for ID Stack tool queries")
    ...
    auto pyClassImGuiContextHook =
        nb::class_<ImGuiContextHook>(m, "ContextHook", "")
    ...
    auto pyClassImGuiContext =
        nb::class_<ImGuiContext>(m, "Context", "")
            ...
            .def_prop_ro("framerate_sec_per_frame", [](ImGuiContext &self) -> nb::ndarray<float, nb::numpy, nb::shape<60>, nb::c_contig>
                         { return self.FramerateSecPerFrame; }, "Calculate estimate of framerate for user over the last 60 frames..")
            ...
            .def(nb::init<ImFontAtlas *>(), nb::arg("shared_font_atlas"));

    auto pyClassImGuiWindowTempData =
        nb::class_<ImGuiWindowTempData>(m, "WindowTempData", " Transient per-window data, reset at the beginning of the frame. This used to be called ImGuiDrawContext, hence the DC variable name in ImGuiWindow.\n (That's theory, in practice the delimitation between ImGuiWindow and ImGuiWindowTempData is quite tenuous and could be reconsidered..)\n (This doesn't need a constructor because we zero-clear it as part of ImGuiWindow and all frame-temporary data are setup on Begin)")
    ...
    auto pyClassImGuiWindow =
        nb::class_<ImGuiWindow>(m, "Window", "Storage for one window")
            ...
            .def("get_id", [](ImGuiWindow &self, const char *str, std::optional<std::string> str_end = std::nullopt) -> ImGuiID
                 {
                ...
                return GetID_adapt_const_char_pointer_with_default_null(str, str_end); }, nb::arg("str"), nb::arg("str_end") = nb::none(), "(private API)")
            .def("get_id", nb::overload_cast<const void *>(&ImGuiWindow::GetID), nb::arg("ptr"), "(private API)")
            .def("get_id", nb::overload_cast<int>(&ImGuiWindow::GetID), nb::arg("n"), "(private API)")
            .def("get_id_from_pos", &ImGuiWindow::GetIDFromPos, nb::arg("p_abs"), "(private API)")
            .def("get_id_from_rectangle", &ImGuiWindow::GetIDFromRectangle, nb::arg("r_abs"), "(private API)")
            .def("rect", &ImGuiWindow::Rect, "(private API)")
            .def("calc_font_size", &ImGuiWindow::CalcFontSize, "(private API)")
            .def("title_bar_rect", &ImGuiWindow::TitleBarRect, "(private API)")
            .def("menu_bar_rect", &ImGuiWindow::MenuBarRect, "(private API)");
    ...
    auto pyClassImGuiTabItem =
        nb::class_<ImGuiTabItem>(m, "TabItem", "Storage for one active tab item (sizeof() 48 bytes)")
    ...
    auto pyClassImGuiTabBar =
        nb::class_<ImGuiTabBar>(m, "TabBar", "Storage for a tab bar (sizeof() 160 bytes)")
    ...
    auto pyClassImGuiTableColumn =
        nb::class_<ImGuiTableColumn>(m, "TableColumn", " [Internal] sizeof() ~ 112\n We use the terminology \"Enabled\" to refer to a column that is not Hidden by user/api.\n We use the terminology \"Clipped\" to refer to a column that is out of sight because of scrolling/clipping.\n This is in contrast with some user-facing api such as IsItemVisible() / IsRectVisible() which use \"Visible\" to mean \"not clipped\".")
    ...
    auto pyClassImGuiTableCellData =
        nb::class_<ImGuiTableCellData>(m, "TableCellData", " Transient cell data stored per row.\n sizeof() ~ 6 bytes")
            ...
            if (Column.has_value())
                ...
                r->Column = ImGuiTableColumnIdx(); }, nb::arg("bg_color") = ImU32(), nb::arg("column") = nb::none())
    ...
    auto pyClassImGuiTableHeaderData =
        nb::class_<ImGuiTableHeaderData>(m, "TableHeaderData", " Parameters for TableAngledHeadersRowEx()\n This may end up being refactored for more general purpose.\n sizeof() ~ 12 bytes")
            ...
            r->BgColor0 = BgColor0;
            r->BgColor1 = BgColor1; }, nb::arg("index") = nb::none(), nb::arg("text_color") = ImU32(), nb::arg("bg_color0") = ImU32(), nb::arg("bg_color1") = ImU32())
    ...
    auto pyClassImGuiTableInstanceData =
        nb::class_<ImGuiTableInstanceData>(m, "TableInstanceData", " Per-instance data that needs preserving across frames (seemingly most others do not need to be preserved aside from debug needs. Does that means they could be moved to ImGuiTableTempData?)\n sizeof() ~ 24 bytes")
    ...
    auto pyClassImGuiTable =
        nb::class_<ImGuiTable>(m, "Table", "sizeof() ~ 592 bytes + heap allocs described in TableBeginInitMemory()")
            ...
            .def_prop_ro("row_bg_color", [](ImGuiTable &self) -> nb::ndarray<ImU32, nb::numpy, nb::shape<2>, nb::c_contig>
                         { return self.RowBgColor; }, "Background color override for current row.")
    ...
    auto pyClassImGuiTableTempData =
        nb::class_<ImGuiTableTempData>(m, "TableTempData", " Transient data that are only needed between BeginTable() and EndTable(), those buffers are shared (1 per level of stacked table).\n - Accessing those requires chasing an extra pointer so for very frequently used data we leave them in the main table structure.\n - We also leave out of this structure data that tend to be particularly useful for debugging/metrics.\n FIXME-TABLE: more transient data could be stored in a stacked ImGuiTableTempData: e.g. SortSpecs.\n sizeof() ~ 136 bytes.")
    ...
    auto pyClassImGuiTableColumnSettings =
        nb::class_<ImGuiTableColumnSettings>(m, "TableColumnSettings", "sizeof() ~ 12")
    ...
    auto pyClassImGuiTableSettings =
        nb::class_<ImGuiTableSettings>(m, "TableSettings", "This is designed to be stored in a single ImChunkStream (1 header followed by N ImGuiTableColumnSettings, etc.)")
    ...
    m.def("log_rendered_text", [](const ImVec2 *ref_pos, const char *text, std::optional<std::string> text_end = std::nullopt)
          {
            ...
            LogRenderedText_adapt_const_char_pointer_with_default_null(ref_pos, text, text_end); }, nb::arg("ref_pos"), nb::arg("text"), nb::arg("text_end") = nb::none());
    ...
    m.def("menu_item_ex", [](const char *label, const char *icon, std::optional<std::string> shortcut = std::nullopt, bool selected = false, bool enabled = true) -> bool
          {
            ...
            return MenuItemEx_adapt_const_char_pointer_with_default_null(label, icon, shortcut, selected, enabled); }, nb::arg("label"), nb::arg("icon"), nb::arg("shortcut") = nb::none(), nb::arg("selected") = false, nb::arg("enabled") = true);
    ...
    m.def("get_typematic_repeat_rate", [](ImGuiInputFlags flags, float repeat_delay, float repeat_rate) -> std::tuple<float, float>
          {
            ...
            return GetTypematicRepeatRate_adapt_modifiable_immutable_to_return(flags, repeat_delay, repeat_rate); }, nb::arg("flags"), nb::arg("repeat_delay"), nb::arg("repeat_rate"));
    ...
    m.def("begin_docked", [](ImGuiWindow *window, bool p_open) -> bool
          {
            ...
            return BeginDocked_adapt_modifiable_immutable_to_return(window, p_open); }, nb::arg("window"), nb::arg("p_open"));
    ...
    auto pyClassDockBuilderSplitNodeResult =
        nb::class_<ImGui::DockBuilderSplitNodeResult>(m, "DockBuilderSplitNodeResult", "")
            ...
            r->id_at_opposite_dir = id_at_opposite_dir; }, nb::arg("id_at_dir") = ImGuiID(), nb::arg("id_at_opposite_dir") = ImGuiID())
    ...
    m.def("dock_builder_split_node", [](ImGuiID node_id, ImGuiDir split_dir, float size_ratio_for_node_at_dir) -> ImGui::DockBuilderSplitNodeResult
          {
            ...
            return DockBuilderSplitNode_adapt_force_lambda(node_id, split_dir, size_ratio_for_node_at_dir); }, nb::arg("node_id"), nb::arg("split_dir"), nb::arg("size_ratio_for_node_at_dir"));
    // #endif
    //
    ...
    m.def("multi_select_item_header", [](ImGuiID id, bool p_selected, ImGuiButtonFlags *p_button_flags) -> bool
          {
            ...
            return MultiSelectItemHeader_adapt_modifiable_immutable_to_return(id, p_selected, p_button_flags); }, nb::arg("id_"), nb::arg("p_selected"), nb::arg("p_button_flags"));

    m.def("multi_select_item_footer", [](ImGuiID id, bool p_selected, bool p_pressed) -> std::tuple<bool, bool>
          {
            ...
            return MultiSelectItemFooter_adapt_modifiable_immutable_to_return(id, p_selected, p_pressed); }, nb::arg("id_"), nb::arg("p_selected"), nb::arg("p_pressed"));
    ...
    m.def("begin_table_ex", [](const char *name, ImGuiID id, int columns_count, ImGuiTableFlags flags = 0, const std::optional<const ImVec2> &outer_size = std::nullopt, float inner_width = 0.0f) -> bool
          {
            ...
            return BeginTableEx_adapt_mutable_param_with_default_value(name, id, columns_count, flags, outer_size, inner_width); }, nb::arg("name"), nb::arg("id_"), nb::arg("columns_count"), nb::arg("flags") = 0, nb::arg("outer_size") = nb::none(), nb::arg("inner_width") = 0.0f, "---\nPython bindings defaults:\n    If outer_size is None, then its default value will be: ImVec2(0, 0)");
    ...
    m.def("tab_item_ex", [](ImGuiTabBar *tab_bar, const char *label, bool p_open, ImGuiTabItemFlags flags, ImGuiWindow *docked_window) -> std::tuple<bool, bool>
          {
            ...
            return TabItemEx_adapt_modifiable_immutable_to_return(tab_bar, label, p_open, flags, docked_window); }, nb::arg("tab_bar"), nb::arg("label"), nb::arg("p_open"), nb::arg("flags"), nb::arg("docked_window"));
    ...
    m.def("tab_item_label_and_close_button", [](ImDrawList *draw_list, const ImRect &bb, ImGuiTabItemFlags flags, ImVec2 frame_padding, const char *label, ImGuiID tab_id, ImGuiID close_button_id, bool is_contents_visible, bool out_just_closed, bool out_text_clipped) -> std::tuple<bool, bool>
          {
            ...
            return TabItemLabelAndCloseButton_adapt_modifiable_immutable_to_return(draw_list, bb, flags, frame_padding, label, tab_id, close_button_id, is_contents_visible, out_just_closed, out_text_clipped); }, nb::arg("draw_list"), nb::arg("bb"), nb::arg("flags"), nb::arg("frame_padding"), nb::arg("label"), nb::arg("tab_id"), nb::arg("close_button_id"), nb::arg("is_contents_visible"), nb::arg("out_just_closed"), nb::arg("out_text_clipped"));

    m.def("render_text", [](ImVec2 pos, const char *text, std::optional<std::string> text_end = std::nullopt, bool hide_text_after_hash = true)
          {
            ...
            RenderText_adapt_const_char_pointer_with_default_null(pos, text, text_end, hide_text_after_hash); }, nb::arg("pos"), nb::arg("text"), nb::arg("text_end") = nb::none(), nb::arg("hide_text_after_hash") = true);

    m.def("render_text_wrapped",
          ImGui::RenderTextWrapped, nb::arg("pos"), nb::arg("text"), nb::arg("text_end"), nb::arg("wrap_width"));

    m.def("render_text_clipped", [](const ImVec2 &pos_min, const ImVec2 &pos_max, const char *text, const char *text_end, const ImVec2 *text_size_if_known, const std::optional<const ImVec2> &align = std::nullopt, const ImRect *clip_rect = NULL)
          {
            ...
            RenderTextClipped_adapt_mutable_param_with_default_value(pos_min, pos_max, text, text_end, text_size_if_known, align, clip_rect); }, nb::arg("pos_min"), nb::arg("pos_max"), nb::arg("text"), nb::arg("text_end"), nb::arg("text_size_if_known"), nb::arg("align") = nb::none(), nb::arg("clip_rect") = nb::none(), "---\nPython bindings defaults:\n    If align is None, then its default value will be: ImVec2(0, 0)");

    m.def("render_text_clipped_ex", [](ImDrawList *draw_list, const ImVec2 &pos_min, const ImVec2 &pos_max, const char *text, const char *text_end, const ImVec2 *text_size_if_known, const std::optional<const ImVec2> &align = std::nullopt, const ImRect *clip_rect = NULL)
          {
            ...
            RenderTextClippedEx_adapt_mutable_param_with_default_value(draw_list, pos_min, pos_max, text, text_end, text_size_if_known, align, clip_rect); }, nb::arg("draw_list"), nb::arg("pos_min"), nb::arg("pos_max"), nb::arg("text"), nb::arg("text_end"), nb::arg("text_size_if_known"), nb::arg("align") = nb::none(), nb::arg("clip_rect") = nb::none(), "---\nPython bindings defaults:\n    If align is None, then its default value will be: ImVec2(0, 0)");
    ...
    m.def("find_rendered_text_end", [](const char *text, std::optional<std::string> text_end = std::nullopt) -> const char *
          {
            ...
            return FindRenderedTextEnd_adapt_const_char_pointer_with_default_null(text, text_end); }, nb::arg("text"), nb::arg("text_end") = nb::none(), "Find the optional ## from which we stop displaying text.", nb::rv_policy::reference);
    ...
    m.def("text_ex", [](const char *text, std::optional<std::string> text_end = std::nullopt, ImGuiTextFlags flags = 0)
          {
            ...
            TextEx_adapt_const_char_pointer_with_default_null(text, text_end, flags); }, nb::arg("text"), nb::arg("text_end") = nb::none(), nb::arg("flags") = 0);

    m.def("button_ex", [](const char *label, const std::optional<const ImVec2> &size_arg = std::nullopt, ImGuiButtonFlags flags = 0) -> bool
          {
            ...
            return ButtonEx_adapt_mutable_param_with_default_value(label, size_arg, flags); }, nb::arg("label"), nb::arg("size_arg") = nb::none(), nb::arg("flags") = 0, "---\nPython bindings defaults:\n    If size_arg is None, then its default value will be: ImVec2(0, 0)");
    ...
    m.def("button_behavior", [](const ImRect &bb, ImGuiID id, bool out_hovered, bool out_held, ImGuiButtonFlags flags = 0) -> std::tuple<bool, bool, bool>
          {
            ...
            return ButtonBehavior_adapt_modifiable_immutable_to_return(bb, id, out_hovered, out_held, flags); }, nb::arg("bb"), nb::arg("id_"), nb::arg("out_hovered"), nb::arg("out_held"), nb::arg("flags") = 0);
    ...
    m.def("splitter_behavior", [](const ImRect &bb, ImGuiID id, ImGuiAxis axis, float size1, float size2, float min_size1, float min_size2, float hover_extend = 0.0f, float hover_visibility_delay = 0.0f, ImU32 bg_col = 0) -> std::tuple<bool, float, float>
          {
            ...
            return SplitterBehavior_adapt_modifiable_immutable_to_return(bb, id, axis, size1, size2, min_size1, min_size2, hover_extend, hover_visibility_delay, bg_col); }, nb::arg("bb"), nb::arg("id_"), nb::arg("axis"), nb::arg("size1"), nb::arg("size2"), nb::arg("min_size1"), nb::arg("min_size2"), nb::arg("hover_extend") = 0.0f, nb::arg("hover_visibility_delay") = 0.0f, nb::arg("bg_col") = 0);

    m.def("tree_node_behavior", [](ImGuiID id, ImGuiTreeNodeFlags flags, const char *label, std::optional<std::string> label_end = std::nullopt) -> bool
          {
            ...
            return TreeNodeBehavior_adapt_const_char_pointer_with_default_null(id, flags, label, label_end); }, nb::arg("id_"), nb::arg("flags"), nb::arg("label"), nb::arg("label_end") = nb::none());
    ...
    m.def("input_text_ex", [](const char *label, const char *hint, std::string s, const ImVec2 &size_arg, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback = NULL) -> std::tuple<bool, std::string>
          {
            ...
            return InputTextEx_adapt_modifiable_immutable_to_return(label, hint, s, size_arg, flags, callback); }, nb::arg("label"), nb::arg("hint"), nb::arg("s"), nb::arg("size_arg"), nb::arg("flags"), nb::arg("callback") = nb::none());

    m.def("temp_input_text", [](const ImRect &bb, ImGuiID id, const char *label, std::string s, ImGuiInputTextFlags flags) -> std::tuple<bool, std::string>
          {
            ...
            return TempInputText_adapt_modifiable_immutable_to_return(bb, id, label, s, flags); }, nb::arg("bb"), nb::arg("id_"), nb::arg("label"), nb::arg("s"), nb::arg("flags"));
    // #endif
    //
    ...
    auto pyClassImFontBuilderIO =
        nb::class_<ImFontBuilderIO>(m, "ImFontBuilderIO", "This structure is likely to evolve as we add support for incremental atlas updates")
            .def(nb::init<>()) // implicit default constructor
        ;
    ...
    auto pyClassImGuiDockRequest =
        nb::class_<ImGuiDockRequest>(m, "DockRequest", "")
    ...
    auto pyClassImGuiDockPreviewData =
        nb::class_<ImGuiDockPreviewData>(m, "DockPreviewData", "")
    ...
    auto pyClassImGuiDockNodeSettings =
        nb::class_<ImGuiDockNodeSettings>(m, "DockNodeSettings", "Persistent Settings data, stored contiguously in SettingsNodes (sizeof() ~32 bytes)")
    ...
    m.def("dock_builder_split_node_py", [](ImGuiID node_id, ImGuiDir split_dir, float size_ratio_for_node_at_dir) -> std::tuple<ImGuiID, ImGuiID, ImGuiID>
          {
            ...
            return DockBuilderSplitNode_Py_adapt_force_lambda(node_id, split_dir, size_ratio_for_node_at_dir); }, nb::arg("node_id"), nb::arg("split_dir"), nb::arg("size_ratio_for_node_at_dir"), " DockBuilderSplitNode_Py() create 2 child nodes within 1 node. The initial node becomes a parent node.\n This version is an adaptation for the python bindings (the C++ version uses two output parameters for the ID of the child nodes, this version returns a tuple)");
    ////////////////////    </generated_from:imgui_internal_pywrappers.h>    ////////////////////
