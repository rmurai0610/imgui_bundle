...
void py_init_module_imgui_main(nb::module_ &m)
{
    ...
    auto pyClassImVec4 =
        nb::class_<ImVec4>(m, "ImVec4", "ImVec4: 4D vector used to store clipping rectangles, colors etc. [Compile-time configurable type]")
            .def_rw("x", &ImVec4::x, "")
            .def_rw("y", &ImVec4::y, "")
            .def_rw("z", &ImVec4::z, "")
            .def_rw("w", &ImVec4::w, "")
    ...
    m.def("show_demo_window", [](std::optional<bool> p_open = std::nullopt) -> std::optional<bool>
          {
            ...
            return ShowDemoWindow_adapt_modifiable_immutable_to_return(p_open); }, nb::arg("p_open") = nb::none(), "create Demo window. demonstrate most ImGui features. call this to learn about the library! try to make it always available in your application!");

    m.def("show_metrics_window", [](std::optional<bool> p_open = std::nullopt) -> std::optional<bool>
          {
            ...
            return ShowMetricsWindow_adapt_modifiable_immutable_to_return(p_open); }, nb::arg("p_open") = nb::none(), "create Metrics/Debugger window. display Dear ImGui internals: windows, draw commands, various internal state, etc.");

    m.def("show_debug_log_window", [](std::optional<bool> p_open = std::nullopt) -> std::optional<bool>
          {
            ...
            return ShowDebugLogWindow_adapt_modifiable_immutable_to_return(p_open); }, nb::arg("p_open") = nb::none(), "create Debug Log window. display a simplified log of important dear imgui events.");

    m.def("show_id_stack_tool_window", [](std::optional<bool> p_open = std::nullopt) -> std::optional<bool>
          {
            ...
            return ShowIDStackToolWindow_adapt_modifiable_immutable_to_return(p_open); }, nb::arg("p_open") = nb::none(), "create Stack Tool window. hover items with mouse to query information about the source of their unique ID.");

    m.def("show_about_window", [](std::optional<bool> p_open = std::nullopt) -> std::optional<bool>
          {
            ...
            return ShowAboutWindow_adapt_modifiable_immutable_to_return(p_open); }, nb::arg("p_open") = nb::none(), "create About window. display Dear ImGui version, credits and build/system information.");
    ...
    m.def("begin", [](const char *name, std::optional<bool> p_open = std::nullopt, ImGuiWindowFlags flags = 0) -> std::tuple<bool, std::optional<bool>>
          {
            ...
            return Begin_adapt_modifiable_immutable_to_return(name, p_open, flags); }, nb::arg("name"), nb::arg("p_open") = nb::none(), nb::arg("flags") = 0);

    m.def("end",
          ImGui::End);

    m.def("begin_child", [](const char *str_id, const std::optional<const ImVec2> &size = std::nullopt, ImGuiChildFlags child_flags = 0, ImGuiWindowFlags window_flags = 0) -> bool
          {
            ...
            return BeginChild_adapt_mutable_param_with_default_value(str_id, size, child_flags, window_flags); }, nb::arg("str_id"), nb::arg("size") = nb::none(), nb::arg("child_flags") = 0, nb::arg("window_flags") = 0, "---\nPython bindings defaults:\n    If size is None, then its default value will be: ImVec2(0, 0)");

    m.def("begin_child", [](ImGuiID id, const std::optional<const ImVec2> &size = std::nullopt, ImGuiChildFlags child_flags = 0, ImGuiWindowFlags window_flags = 0) -> bool
          {
            ...
            return BeginChild_adapt_mutable_param_with_default_value(id, size, child_flags, window_flags); }, nb::arg("id_"), nb::arg("size") = nb::none(), nb::arg("child_flags") = 0, nb::arg("window_flags") = 0, "---\nPython bindings defaults:\n    If size is None, then its default value will be: ImVec2(0, 0)");
    ...
    m.def("set_next_window_pos", [](const ImVec2 &pos, ImGuiCond cond = 0, const std::optional<const ImVec2> &pivot = std::nullopt)
          {
            ...
            SetNextWindowPos_adapt_mutable_param_with_default_value(pos, cond, pivot); }, nb::arg("pos"), nb::arg("cond") = 0, nb::arg("pivot") = nb::none(), "---\nPython bindings defaults:\n    If pivot is None, then its default value will be: ImVec2(0, 0)\n\n set next window position. call before Begin(). use pivot=(0.5,0.5) to center on given point, etc.");
    ...
    m.def("text_unformatted", [](const char *text, std::optional<std::string> text_end = std::nullopt)
          {
            ...
            TextUnformatted_adapt_const_char_pointer_with_default_null(text, text_end); }, nb::arg("text"), nb::arg("text_end") = nb::none(), "raw text without formatting. Roughly equivalent to Text(\"%s\", text) but: A) doesn't require null terminated string if 'text_end' is specified, B) it's faster, no memory copy is done, no buffer size limits, recommended for long chunks of text.");
    ...
    m.def("text", [](const char *fmt)
          {
            ...
            Text_adapt_variadic_format(fmt); }, nb::arg("fmt"), "formatted text");
    ...
    m.def("text_colored", [](const ImVec4 &col, const char *fmt)
          {
            ...
            TextColored_adapt_variadic_format(col, fmt); }, nb::arg("col"), nb::arg("fmt"), "shortcut for PushStyleColor(ImGuiCol_Text, col); Text(fmt, ...); PopStyleColor();");
    ...
    m.def("text_disabled", [](const char *fmt)
          {
            ...
            TextDisabled_adapt_variadic_format(fmt); }, nb::arg("fmt"), "shortcut for PushStyleColor(ImGuiCol_Text, style.Colors[ImGuiCol_TextDisabled]); Text(fmt, ...); PopStyleColor();");
    ...
    m.def("text_wrapped", [](const char *fmt)
          {
            ...
            TextWrapped_adapt_variadic_format(fmt); }, nb::arg("fmt"), "shortcut for PushTextWrapPos(0.0); Text(fmt, ...); PopTextWrapPos();. Note that this won't work on an auto-resizing window if there's no other widgets to extend the window width, yoy may need to set a size using SetNextWindowSize().");
    ...
    m.def("label_text", [](const char *label, const char *fmt)
          {
            ...
            LabelText_adapt_variadic_format(label, fmt); }, nb::arg("label"), nb::arg("fmt"), "display text+label aligned the same way as value+label widgets");
    ...
    m.def("bullet_text", [](const char *fmt)
          {
            ...
            BulletText_adapt_variadic_format(fmt); }, nb::arg("fmt"), "shortcut for Bullet()+Text()");
    ...
    m.def("button", [](const char *label, const std::optional<const ImVec2> &size = std::nullopt) -> bool
          {
            ...
            return Button_adapt_mutable_param_with_default_value(label, size); }, nb::arg("label"), nb::arg("size") = nb::none(), "---\nPython bindings defaults:\n    If size is None, then its default value will be: ImVec2(0, 0)\n\n button");
    ...
    m.def("checkbox", [](const char *label, bool v) -> std::tuple<bool, bool>
          {
            ...
            return Checkbox_adapt_modifiable_immutable_to_return(label, v); }, nb::arg("label"), nb::arg("v"));

    m.def("checkbox_flags", [](const char *label, int flags, int flags_value) -> std::tuple<bool, int>
          {
            ...
            return CheckboxFlags_adapt_modifiable_immutable_to_return(label, flags, flags_value); }, nb::arg("label"), nb::arg("flags"), nb::arg("flags_value"));

    m.def("checkbox_flags", [](const char *label, unsigned int flags, unsigned int flags_value) -> std::tuple<bool, unsigned int>
          {
    ...
    m.def("radio_button", [](const char *label, int v, int v_button) -> std::tuple<bool, int>
          {
            ...
            return RadioButton_adapt_modifiable_immutable_to_return(label, v, v_button); }, nb::arg("label"), nb::arg("v"), nb::arg("v_button"), "shortcut to handle the above pattern when value is an integer");

    m.def("progress_bar", [](float fraction, const std::optional<const ImVec2> &size_arg = std::nullopt, std::optional<std::string> overlay = std::nullopt)
          {
            ...
            ProgressBar_adapt_const_char_pointer_with_default_null(fraction, size_arg, overlay); }, nb::arg("fraction"), nb::arg("size_arg") = nb::none(), nb::arg("overlay") = nb::none(), "---\nPython bindings defaults:\n    If size_arg is None, then its default value will be: ImVec2(-sys.float_info.min, 0)");
    ...
    m.def("text_link_open_url", [](const char *label, std::optional<std::string> url = std::nullopt)
          {
            ...
            TextLinkOpenURL_adapt_const_char_pointer_with_default_null(label, url); }, nb::arg("label"), nb::arg("url") = nb::none(), "hyperlink text button, automatically open file/url when clicked");

    m.def("image", [](ImTextureID user_texture_id, const ImVec2 &image_size, const std::optional<const ImVec2> &uv0 = std::nullopt, const std::optional<const ImVec2> &uv1 = std::nullopt, const std::optional<const ImVec4> &tint_col = std::nullopt, const std::optional<const ImVec4> &border_col = std::nullopt)
          {
            ...
            Image_adapt_mutable_param_with_default_value(user_texture_id, image_size, uv0, uv1, tint_col, border_col); }, nb::arg("user_texture_id"), nb::arg("image_size"), nb::arg("uv0") = nb::none(), nb::arg("uv1") = nb::none(), nb::arg("tint_col") = nb::none(), nb::arg("border_col") = nb::none(), "---\nPython bindings defaults:\n    If any of the params below is None, then its default value below will be used:\n        uv0: ImVec2(0, 0)\n        uv1: ImVec2(1, 1)\n        tint_col: ImVec4(1, 1, 1, 1)\n        border_col: ImVec4(0, 0, 0, 0)");

    m.def("image_button", [](const char *str_id, ImTextureID user_texture_id, const ImVec2 &image_size, const std::optional<const ImVec2> &uv0 = std::nullopt, const std::optional<const ImVec2> &uv1 = std::nullopt, const std::optional<const ImVec4> &bg_col = std::nullopt, const std::optional<const ImVec4> &tint_col = std::nullopt) -> bool
          {
            ...
            return ImageButton_adapt_mutable_param_with_default_value(str_id, user_texture_id, image_size, uv0, uv1, bg_col, tint_col); }, nb::arg("str_id"), nb::arg("user_texture_id"), nb::arg("image_size"), nb::arg("uv0") = nb::none(), nb::arg("uv1") = nb::none(), nb::arg("bg_col") = nb::none(), nb::arg("tint_col") = nb::none(), "---\nPython bindings defaults:\n    If any of the params below is None, then its default value below will be used:\n        uv0: ImVec2(0, 0)\n        uv1: ImVec2(1, 1)\n        bg_col: ImVec4(0, 0, 0, 0)\n        tint_col: ImVec4(1, 1, 1, 1)");
    ...
    m.def("combo", [](const char *label, int current_item, const std::vector<std::string> &items, int popup_max_height_in_items = -1) -> std::tuple<bool, int>
          {
            ...
            return Combo_adapt_c_string_list(label, current_item, items, popup_max_height_in_items); }, nb::arg("label"), nb::arg("current_item"), nb::arg("items"), nb::arg("popup_max_height_in_items") = -1);

    m.def("combo", [](const char *label, int current_item, const char *items_separated_by_zeros, int popup_max_height_in_items = -1) -> std::tuple<bool, int>
          {
            ...
            return Combo_adapt_modifiable_immutable_to_return(label, current_item, items_separated_by_zeros, popup_max_height_in_items); }, nb::arg("label"), nb::arg("current_item"), nb::arg("items_separated_by_zeros"), nb::arg("popup_max_height_in_items") = -1, "Separate items with \\0 within a string, end item-list with \\0\\0. e.g. \"One\\0Two\\0Three\\0\"");

    m.def("drag_float", [](const char *label, float v, float v_speed = 1.0f, float v_min = 0.0f, float v_max = 0.0f, const char *format = "%.3f", ImGuiSliderFlags flags = 0) -> std::tuple<bool, float>
          {
            ...
            return DragFloat_adapt_modifiable_immutable_to_return(label, v, v_speed, v_min, v_max, format, flags); }, nb::arg("label"), nb::arg("v"), nb::arg("v_speed") = 1.0f, nb::arg("v_min") = 0.0f, nb::arg("v_max") = 0.0f, nb::arg("format") = "%.3f", nb::arg("flags") = 0, "If v_min >= v_max we have no bound");

    m.def("drag_float2", [](const char *label, std::array<float, 2> v, float v_speed = 1.0f, float v_min = 0.0f, float v_max = 0.0f, const char *format = "%.3f", ImGuiSliderFlags flags = 0) -> std::tuple<bool, std::array<float, 2>>
          {
            ...
            return DragFloat2_adapt_modifiable_immutable_to_return(label, v, v_speed, v_min, v_max, format, flags); }, nb::arg("label"), nb::arg("v"), nb::arg("v_speed") = 1.0f, nb::arg("v_min") = 0.0f, nb::arg("v_max") = 0.0f, nb::arg("format") = "%.3f", nb::arg("flags") = 0);

    m.def("drag_float3", [](const char *label, std::array<float, 3> v, float v_speed = 1.0f, float v_min = 0.0f, float v_max = 0.0f, const char *format = "%.3f", ImGuiSliderFlags flags = 0) -> std::tuple<bool, std::array<float, 3>>
          {
            ...
            return DragFloat3_adapt_modifiable_immutable_to_return(label, v, v_speed, v_min, v_max, format, flags); }, nb::arg("label"), nb::arg("v"), nb::arg("v_speed") = 1.0f, nb::arg("v_min") = 0.0f, nb::arg("v_max") = 0.0f, nb::arg("format") = "%.3f", nb::arg("flags") = 0);

    m.def("drag_float4", [](const char *label, std::array<float, 4> v, float v_speed = 1.0f, float v_min = 0.0f, float v_max = 0.0f, const char *format = "%.3f", ImGuiSliderFlags flags = 0) -> std::tuple<bool, std::array<float, 4>>
          {
            ...
            return DragFloat4_adapt_modifiable_immutable_to_return(label, v, v_speed, v_min, v_max, format, flags); }, nb::arg("label"), nb::arg("v"), nb::arg("v_speed") = 1.0f, nb::arg("v_min") = 0.0f, nb::arg("v_max") = 0.0f, nb::arg("format") = "%.3f", nb::arg("flags") = 0);

    m.def("drag_float_range2", [](const char *label, float v_current_min, float v_current_max, float v_speed = 1.0f, float v_min = 0.0f, float v_max = 0.0f, const char *format = "%.3f", std::optional<std::string> format_max = std::nullopt, ImGuiSliderFlags flags = 0) -> std::tuple<bool, float, float>
          {
            ...
            return DragFloatRange2_adapt_modifiable_immutable_to_return(label, v_current_min, v_current_max, v_speed, v_min, v_max, format, format_max, flags); }, nb::arg("label"), nb::arg("v_current_min"), nb::arg("v_current_max"), nb::arg("v_speed") = 1.0f, nb::arg("v_min") = 0.0f, nb::arg("v_max") = 0.0f, nb::arg("format") = "%.3f", nb::arg("format_max") = nb::none(), nb::arg("flags") = 0);

    m.def("drag_int", [](const char *label, int v, float v_speed = 1.0f, int v_min = 0, int v_max = 0, const char *format = "%d", ImGuiSliderFlags flags = 0) -> std::tuple<bool, int>
          {
            ...
            return DragInt_adapt_modifiable_immutable_to_return(label, v, v_speed, v_min, v_max, format, flags); }, nb::arg("label"), nb::arg("v"), nb::arg("v_speed") = 1.0f, nb::arg("v_min") = 0, nb::arg("v_max") = 0, nb::arg("format") = "%d", nb::arg("flags") = 0, "If v_min >= v_max we have no bound");

    m.def("drag_int2", [](const char *label, std::array<int, 2> v, float v_speed = 1.0f, int v_min = 0, int v_max = 0, const char *format = "%d", ImGuiSliderFlags flags = 0) -> std::tuple<bool, std::array<int, 2>>
          {
            ...
            return DragInt2_adapt_modifiable_immutable_to_return(label, v, v_speed, v_min, v_max, format, flags); }, nb::arg("label"), nb::arg("v"), nb::arg("v_speed") = 1.0f, nb::arg("v_min") = 0, nb::arg("v_max") = 0, nb::arg("format") = "%d", nb::arg("flags") = 0);

    m.def("drag_int3", [](const char *label, std::array<int, 3> v, float v_speed = 1.0f, int v_min = 0, int v_max = 0, const char *format = "%d", ImGuiSliderFlags flags = 0) -> std::tuple<bool, std::array<int, 3>>
          {
            ...
            return DragInt3_adapt_modifiable_immutable_to_return(label, v, v_speed, v_min, v_max, format, flags); }, nb::arg("label"), nb::arg("v"), nb::arg("v_speed") = 1.0f, nb::arg("v_min") = 0, nb::arg("v_max") = 0, nb::arg("format") = "%d", nb::arg("flags") = 0);

    m.def("drag_int4", [](const char *label, std::array<int, 4> v, float v_speed = 1.0f, int v_min = 0, int v_max = 0, const char *format = "%d", ImGuiSliderFlags flags = 0) -> std::tuple<bool, std::array<int, 4>>
          {
            ...
            return DragInt4_adapt_modifiable_immutable_to_return(label, v, v_speed, v_min, v_max, format, flags); }, nb::arg("label"), nb::arg("v"), nb::arg("v_speed") = 1.0f, nb::arg("v_min") = 0, nb::arg("v_max") = 0, nb::arg("format") = "%d", nb::arg("flags") = 0);

    m.def("drag_int_range2", [](const char *label, int v_current_min, int v_current_max, float v_speed = 1.0f, int v_min = 0, int v_max = 0, const char *format = "%d", std::optional<std::string> format_max = std::nullopt, ImGuiSliderFlags flags = 0) -> std::tuple<bool, int, int>
          {
            ...
            return DragIntRange2_adapt_modifiable_immutable_to_return(label, v_current_min, v_current_max, v_speed, v_min, v_max, format, format_max, flags); }, nb::arg("label"), nb::arg("v_current_min"), nb::arg("v_current_max"), nb::arg("v_speed") = 1.0f, nb::arg("v_min") = 0, nb::arg("v_max") = 0, nb::arg("format") = "%d", nb::arg("format_max") = nb::none(), nb::arg("flags") = 0);

    m.def("drag_scalar", [](const char *label, ImGuiDataType data_type, void *p_data, float v_speed = 1.0f, const void *p_min = NULL, const void *p_max = NULL, std::optional<std::string> format = std::nullopt, ImGuiSliderFlags flags = 0) -> bool
          {
            ...
            return DragScalar_adapt_const_char_pointer_with_default_null(label, data_type, p_data, v_speed, p_min, p_max, format, flags); }, nb::arg("label"), nb::arg("data_type"), nb::arg("p_data"), nb::arg("v_speed") = 1.0f, nb::arg("p_min") = nb::none(), nb::arg("p_max") = nb::none(), nb::arg("format") = nb::none(), nb::arg("flags") = 0);

    m.def("drag_scalar_n", [](const char *label, ImGuiDataType data_type, void *p_data, int components, float v_speed = 1.0f, const void *p_min = NULL, const void *p_max = NULL, std::optional<std::string> format = std::nullopt, ImGuiSliderFlags flags = 0) -> bool
          {
            ...
            return DragScalarN_adapt_const_char_pointer_with_default_null(label, data_type, p_data, components, v_speed, p_min, p_max, format, flags); }, nb::arg("label"), nb::arg("data_type"), nb::arg("p_data"), nb::arg("components"), nb::arg("v_speed") = 1.0f, nb::arg("p_min") = nb::none(), nb::arg("p_max") = nb::none(), nb::arg("format") = nb::none(), nb::arg("flags") = 0);

    m.def("slider_float", [](const char *label, float v, float v_min, float v_max, const char *format = "%.3f", ImGuiSliderFlags flags = 0) -> std::tuple<bool, float>
          {
            ...
            return SliderFloat_adapt_modifiable_immutable_to_return(label, v, v_min, v_max, format, flags); }, nb::arg("label"), nb::arg("v"), nb::arg("v_min"), nb::arg("v_max"), nb::arg("format") = "%.3f", nb::arg("flags") = 0, "adjust format to decorate the value with a prefix or a suffix for in-slider labels or unit display.");

    m.def("slider_float2", [](const char *label, std::array<float, 2> v, float v_min, float v_max, const char *format = "%.3f", ImGuiSliderFlags flags = 0) -> std::tuple<bool, std::array<float, 2>>
          {
            ...
            return SliderFloat2_adapt_modifiable_immutable_to_return(label, v, v_min, v_max, format, flags); }, nb::arg("label"), nb::arg("v"), nb::arg("v_min"), nb::arg("v_max"), nb::arg("format") = "%.3f", nb::arg("flags") = 0);

    m.def("slider_float3", [](const char *label, std::array<float, 3> v, float v_min, float v_max, const char *format = "%.3f", ImGuiSliderFlags flags = 0) -> std::tuple<bool, std::array<float, 3>>
          {
            ...
            return SliderFloat3_adapt_modifiable_immutable_to_return(label, v, v_min, v_max, format, flags); }, nb::arg("label"), nb::arg("v"), nb::arg("v_min"), nb::arg("v_max"), nb::arg("format") = "%.3f", nb::arg("flags") = 0);

    m.def("slider_float4", [](const char *label, std::array<float, 4> v, float v_min, float v_max, const char *format = "%.3f", ImGuiSliderFlags flags = 0) -> std::tuple<bool, std::array<float, 4>>
          {
            ...
            return SliderFloat4_adapt_modifiable_immutable_to_return(label, v, v_min, v_max, format, flags); }, nb::arg("label"), nb::arg("v"), nb::arg("v_min"), nb::arg("v_max"), nb::arg("format") = "%.3f", nb::arg("flags") = 0);

    m.def("slider_angle", [](const char *label, float v_rad, float v_degrees_min = -360.0f, float v_degrees_max = +360.0f, const char *format = "%.0f deg", ImGuiSliderFlags flags = 0) -> std::tuple<bool, float>
          {
            ...
            return SliderAngle_adapt_modifiable_immutable_to_return(label, v_rad, v_degrees_min, v_degrees_max, format, flags); }, nb::arg("label"), nb::arg("v_rad"), nb::arg("v_degrees_min") = -360.0f, nb::arg("v_degrees_max") = +360.0f, nb::arg("format") = "%.0f deg", nb::arg("flags") = 0);

    m.def("slider_int", [](const char *label, int v, int v_min, int v_max, const char *format = "%d", ImGuiSliderFlags flags = 0) -> std::tuple<bool, int>
          {
            ...
            return SliderInt_adapt_modifiable_immutable_to_return(label, v, v_min, v_max, format, flags); }, nb::arg("label"), nb::arg("v"), nb::arg("v_min"), nb::arg("v_max"), nb::arg("format") = "%d", nb::arg("flags") = 0);

    m.def("slider_int2", [](const char *label, std::array<int, 2> v, int v_min, int v_max, const char *format = "%d", ImGuiSliderFlags flags = 0) -> std::tuple<bool, std::array<int, 2>>
          {
            ...
            return SliderInt2_adapt_modifiable_immutable_to_return(label, v, v_min, v_max, format, flags); }, nb::arg("label"), nb::arg("v"), nb::arg("v_min"), nb::arg("v_max"), nb::arg("format") = "%d", nb::arg("flags") = 0);

    m.def("slider_int3", [](const char *label, std::array<int, 3> v, int v_min, int v_max, const char *format = "%d", ImGuiSliderFlags flags = 0) -> std::tuple<bool, std::array<int, 3>>
          {
            ...
            return SliderInt3_adapt_modifiable_immutable_to_return(label, v, v_min, v_max, format, flags); }, nb::arg("label"), nb::arg("v"), nb::arg("v_min"), nb::arg("v_max"), nb::arg("format") = "%d", nb::arg("flags") = 0);

    m.def("slider_int4", [](const char *label, std::array<int, 4> v, int v_min, int v_max, const char *format = "%d", ImGuiSliderFlags flags = 0) -> std::tuple<bool, std::array<int, 4>>
          {
            ...
            return SliderInt4_adapt_modifiable_immutable_to_return(label, v, v_min, v_max, format, flags); }, nb::arg("label"), nb::arg("v"), nb::arg("v_min"), nb::arg("v_max"), nb::arg("format") = "%d", nb::arg("flags") = 0);

    m.def("slider_scalar", [](const char *label, ImGuiDataType data_type, void *p_data, const void *p_min, const void *p_max, std::optional<std::string> format = std::nullopt, ImGuiSliderFlags flags = 0) -> bool
          {
            ...
            return SliderScalar_adapt_const_char_pointer_with_default_null(label, data_type, p_data, p_min, p_max, format, flags); }, nb::arg("label"), nb::arg("data_type"), nb::arg("p_data"), nb::arg("p_min"), nb::arg("p_max"), nb::arg("format") = nb::none(), nb::arg("flags") = 0);

    m.def("slider_scalar_n", [](const char *label, ImGuiDataType data_type, void *p_data, int components, const void *p_min, const void *p_max, std::optional<std::string> format = std::nullopt, ImGuiSliderFlags flags = 0) -> bool
          {
            ...
            return SliderScalarN_adapt_const_char_pointer_with_default_null(label, data_type, p_data, components, p_min, p_max, format, flags); }, nb::arg("label"), nb::arg("data_type"), nb::arg("p_data"), nb::arg("components"), nb::arg("p_min"), nb::arg("p_max"), nb::arg("format") = nb::none(), nb::arg("flags") = 0);

    m.def("v_slider_float", [](const char *label, const ImVec2 &size, float v, float v_min, float v_max, const char *format = "%.3f", ImGuiSliderFlags flags = 0) -> std::tuple<bool, float>
          {
            ...
            return VSliderFloat_adapt_modifiable_immutable_to_return(label, size, v, v_min, v_max, format, flags); }, nb::arg("label"), nb::arg("size"), nb::arg("v"), nb::arg("v_min"), nb::arg("v_max"), nb::arg("format") = "%.3f", nb::arg("flags") = 0);

    m.def("v_slider_int", [](const char *label, const ImVec2 &size, int v, int v_min, int v_max, const char *format = "%d", ImGuiSliderFlags flags = 0) -> std::tuple<bool, int>
          {
            ...
            return VSliderInt_adapt_modifiable_immutable_to_return(label, size, v, v_min, v_max, format, flags); }, nb::arg("label"), nb::arg("size"), nb::arg("v"), nb::arg("v_min"), nb::arg("v_max"), nb::arg("format") = "%d", nb::arg("flags") = 0);

    m.def("v_slider_scalar", [](const char *label, const ImVec2 &size, ImGuiDataType data_type, void *p_data, const void *p_min, const void *p_max, std::optional<std::string> format = std::nullopt, ImGuiSliderFlags flags = 0) -> bool
          {
            ...
            return VSliderScalar_adapt_const_char_pointer_with_default_null(label, size, data_type, p_data, p_min, p_max, format, flags); }, nb::arg("label"), nb::arg("size"), nb::arg("data_type"), nb::arg("p_data"), nb::arg("p_min"), nb::arg("p_max"), nb::arg("format") = nb::none(), nb::arg("flags") = 0);

    m.def("input_float", [](const char *label, float v, float step = 0.0f, float step_fast = 0.0f, const char *format = "%.3f", ImGuiInputTextFlags flags = 0) -> std::tuple<bool, float>
          {
            ...
            return InputFloat_adapt_modifiable_immutable_to_return(label, v, step, step_fast, format, flags); }, nb::arg("label"), nb::arg("v"), nb::arg("step") = 0.0f, nb::arg("step_fast") = 0.0f, nb::arg("format") = "%.3f", nb::arg("flags") = 0);

    m.def("input_float2", [](const char *label, std::array<float, 2> v, const char *format = "%.3f", ImGuiInputTextFlags flags = 0) -> std::tuple<bool, std::array<float, 2>>
          {
            ...
            return InputFloat2_adapt_modifiable_immutable_to_return(label, v, format, flags); }, nb::arg("label"), nb::arg("v"), nb::arg("format") = "%.3f", nb::arg("flags") = 0);

    m.def("input_float3", [](const char *label, std::array<float, 3> v, const char *format = "%.3f", ImGuiInputTextFlags flags = 0) -> std::tuple<bool, std::array<float, 3>>
          {
            ...
            return InputFloat3_adapt_modifiable_immutable_to_return(label, v, format, flags); }, nb::arg("label"), nb::arg("v"), nb::arg("format") = "%.3f", nb::arg("flags") = 0);

    m.def("input_float4", [](const char *label, std::array<float, 4> v, const char *format = "%.3f", ImGuiInputTextFlags flags = 0) -> std::tuple<bool, std::array<float, 4>>
          {
            ...
            return InputFloat4_adapt_modifiable_immutable_to_return(label, v, format, flags); }, nb::arg("label"), nb::arg("v"), nb::arg("format") = "%.3f", nb::arg("flags") = 0);

    m.def("input_int", [](const char *label, int v, int step = 1, int step_fast = 100, ImGuiInputTextFlags flags = 0) -> std::tuple<bool, int>
          {
            ...
            return InputInt_adapt_modifiable_immutable_to_return(label, v, step, step_fast, flags); }, nb::arg("label"), nb::arg("v"), nb::arg("step") = 1, nb::arg("step_fast") = 100, nb::arg("flags") = 0);

    m.def("input_int2", [](const char *label, std::array<int, 2> v, ImGuiInputTextFlags flags = 0) -> std::tuple<bool, std::array<int, 2>>
          {
            ...
            return InputInt2_adapt_modifiable_immutable_to_return(label, v, flags); }, nb::arg("label"), nb::arg("v"), nb::arg("flags") = 0);

    m.def("input_int3", [](const char *label, std::array<int, 3> v, ImGuiInputTextFlags flags = 0) -> std::tuple<bool, std::array<int, 3>>
          {
            ...
            return InputInt3_adapt_modifiable_immutable_to_return(label, v, flags); }, nb::arg("label"), nb::arg("v"), nb::arg("flags") = 0);

    m.def("input_int4", [](const char *label, std::array<int, 4> v, ImGuiInputTextFlags flags = 0) -> std::tuple<bool, std::array<int, 4>>
          {
            ...
            return InputInt4_adapt_modifiable_immutable_to_return(label, v, flags); }, nb::arg("label"), nb::arg("v"), nb::arg("flags") = 0);

    m.def("input_double", [](const char *label, double v, double step = 0.0, double step_fast = 0.0, const char *format = "%.6f", ImGuiInputTextFlags flags = 0) -> std::tuple<bool, double>
          {
            ...
            return InputDouble_adapt_modifiable_immutable_to_return(label, v, step, step_fast, format, flags); }, nb::arg("label"), nb::arg("v"), nb::arg("step") = 0.0, nb::arg("step_fast") = 0.0, nb::arg("format") = "%.6f", nb::arg("flags") = 0);

    m.def("input_scalar", [](const char *label, ImGuiDataType data_type, void *p_data, const void *p_step = NULL, const void *p_step_fast = NULL, std::optional<std::string> format = std::nullopt, ImGuiInputTextFlags flags = 0) -> bool
          {
            ...
            return InputScalar_adapt_const_char_pointer_with_default_null(label, data_type, p_data, p_step, p_step_fast, format, flags); }, nb::arg("label"), nb::arg("data_type"), nb::arg("p_data"), nb::arg("p_step") = nb::none(), nb::arg("p_step_fast") = nb::none(), nb::arg("format") = nb::none(), nb::arg("flags") = 0);

    m.def("input_scalar_n", [](const char *label, ImGuiDataType data_type, void *p_data, int components, const void *p_step = NULL, const void *p_step_fast = NULL, std::optional<std::string> format = std::nullopt, ImGuiInputTextFlags flags = 0) -> bool
          {
            ...
            return InputScalarN_adapt_const_char_pointer_with_default_null(label, data_type, p_data, components, p_step, p_step_fast, format, flags); }, nb::arg("label"), nb::arg("data_type"), nb::arg("p_data"), nb::arg("components"), nb::arg("p_step") = nb::none(), nb::arg("p_step_fast") = nb::none(), nb::arg("format") = nb::none(), nb::arg("flags") = 0);

    m.def("color_edit3", [](const char *label, std::array<float, 3> col, ImGuiColorEditFlags flags = 0) -> std::tuple<bool, std::array<float, 3>>
          {
            ...
            return ColorEdit3_adapt_modifiable_immutable_to_return(label, col, flags); }, nb::arg("label"), nb::arg("col"), nb::arg("flags") = 0);

    m.def("color_edit4", [](const char *label, std::array<float, 4> col, ImGuiColorEditFlags flags = 0) -> std::tuple<bool, std::array<float, 4>>
          {
            ...
            return ColorEdit4_adapt_modifiable_immutable_to_return(label, col, flags); }, nb::arg("label"), nb::arg("col"), nb::arg("flags") = 0);

    m.def("color_picker3", [](const char *label, std::array<float, 3> col, ImGuiColorEditFlags flags = 0) -> std::tuple<bool, std::array<float, 3>>
          {
            ...
            return ColorPicker3_adapt_modifiable_immutable_to_return(label, col, flags); }, nb::arg("label"), nb::arg("col"), nb::arg("flags") = 0);
    // #ifdef IMGUI_BUNDLE_PYTHON_API
    //
    ...
    m.def("color_button", [](const char *desc_id, const ImVec4 &col, ImGuiColorEditFlags flags = 0, const std::optional<const ImVec2> &size = std::nullopt) -> bool
          {
            ...
            return ColorButton_adapt_mutable_param_with_default_value(desc_id, col, flags, size); }, nb::arg("desc_id"), nb::arg("col"), nb::arg("flags") = 0, nb::arg("size") = nb::none(), "---\nPython bindings defaults:\n    If size is None, then its default value will be: ImVec2(0, 0)\n\n display a color square/button, hover for details, return True when pressed.");
    ...
    m.def("tree_node", [](const char *str_id, const char *fmt) -> bool
          {
            ...
            return TreeNode_adapt_variadic_format(str_id, fmt); }, nb::arg("str_id"), nb::arg("fmt"), "helper variation to easily decorelate the id from the displayed string. Read the FAQ about why and how to use ID. to align arbitrary text at the same level as a TreeNode() you can use Bullet().");

    m.def("tree_node", [](const void *ptr_id, const char *fmt) -> bool
          {
            ...
            return TreeNode_adapt_variadic_format(ptr_id, fmt); }, nb::arg("ptr_id"), nb::arg("fmt"), "\"");

    m.def("tree_node_ex",
          nb::overload_cast<const char *, ImGuiTreeNodeFlags>(ImGui::TreeNodeEx), nb::arg("label"), nb::arg("flags") = 0);

    m.def("tree_node_ex", [](const char *str_id, ImGuiTreeNodeFlags flags, const char *fmt) -> bool
          {
            ...
            return TreeNodeEx_adapt_variadic_format(str_id, flags, fmt); }, nb::arg("str_id"), nb::arg("flags"), nb::arg("fmt"));

    m.def("tree_node_ex", [](const void *ptr_id, ImGuiTreeNodeFlags flags, const char *fmt) -> bool
          {
            ...
            return TreeNodeEx_adapt_variadic_format(ptr_id, flags, fmt); }, nb::arg("ptr_id"), nb::arg("flags"), nb::arg("fmt"));
    ...
    m.def("collapsing_header", [](const char *label, bool p_visible, ImGuiTreeNodeFlags flags = 0) -> std::tuple<bool, bool>
          {
            ...
            return CollapsingHeader_adapt_modifiable_immutable_to_return(label, p_visible, flags); }, nb::arg("label"), nb::arg("p_visible"), nb::arg("flags") = 0, "when 'p_visible != None': if '*p_visible==True' display an additional small close button on upper right of the header which will set the bool to False when clicked, if '*p_visible==False' don't display the header.");
    ...
    m.def("selectable", [](const char *label, bool p_selected, ImGuiSelectableFlags flags = 0, const std::optional<const ImVec2> &size = std::nullopt) -> std::tuple<bool, bool>
          {
            ...
            return Selectable_adapt_modifiable_immutable_to_return(label, p_selected, flags, size); }, nb::arg("label"), nb::arg("p_selected"), nb::arg("flags") = 0, nb::arg("size") = nb::none(), "---\nPython bindings defaults:\n    If size is None, then its default value will be: ImVec2(0, 0)\n\n \"bool* p_selected\" point to the selection state (read-write), as a convenient helper.");
    ...
    m.def("begin_list_box", [](const char *label, const std::optional<const ImVec2> &size = std::nullopt) -> bool
          {
            ...
            return BeginListBox_adapt_mutable_param_with_default_value(label, size); }, nb::arg("label"), nb::arg("size") = nb::none(), "---\nPython bindings defaults:\n    If size is None, then its default value will be: ImVec2(0, 0)\n\n open a framed scrolling region");

    m.def("end_list_box",
          ImGui::EndListBox, "only call EndListBox() if BeginListBox() returned True!");

    m.def("list_box", [](const char *label, int current_item, const std::vector<std::string> &items, int height_in_items = -1) -> std::tuple<bool, int>
          {
            ...
            return ListBox_adapt_c_string_list(label, current_item, items, height_in_items); }, nb::arg("label"), nb::arg("current_item"), nb::arg("items"), nb::arg("height_in_items") = -1);

    m.def("plot_lines", [](const char *label, const nb::ndarray<> &values, int values_offset = 0, std::optional<std::string> overlay_text = std::nullopt, float scale_min = FLT_MAX, float scale_max = FLT_MAX, const std::optional<const ImVec2> &graph_size = std::nullopt, int stride = -1)
          {
            ...
            PlotLines_adapt_const_char_pointer_with_default_null(label, values, values_offset, overlay_text, scale_min, scale_max, graph_size, stride); }, nb::arg("label"), nb::arg("values"), nb::arg("values_offset") = 0, nb::arg("overlay_text") = nb::none(), nb::arg("scale_min") = FLT_MAX, nb::arg("scale_max") = FLT_MAX, nb::arg("graph_size") = nb::none(), nb::arg("stride") = -1, "---\nPython bindings defaults:\n    If graph_size is None, then its default value will be: ImVec2(0, 0)");

    m.def("plot_histogram", [](const char *label, const nb::ndarray<> &values, int values_offset = 0, std::optional<std::string> overlay_text = std::nullopt, float scale_min = FLT_MAX, float scale_max = FLT_MAX, const std::optional<const ImVec2> &graph_size = std::nullopt, int stride = -1)
          {
            ...
            PlotHistogram_adapt_const_char_pointer_with_default_null(label, values, values_offset, overlay_text, scale_min, scale_max, graph_size, stride); }, nb::arg("label"), nb::arg("values"), nb::arg("values_offset") = 0, nb::arg("overlay_text") = nb::none(), nb::arg("scale_min") = FLT_MAX, nb::arg("scale_max") = FLT_MAX, nb::arg("graph_size") = nb::none(), nb::arg("stride") = -1, "---\nPython bindings defaults:\n    If graph_size is None, then its default value will be: ImVec2(0, 0)");
    ...
    m.def("value", [](const char *prefix, float v, std::optional<std::string> float_format = std::nullopt)
          {
            ...
            Value_adapt_const_char_pointer_with_default_null(prefix, v, float_format); }, nb::arg("prefix"), nb::arg("v"), nb::arg("float_format") = nb::none());
    ...
    m.def("menu_item_simple", [](const char *label, std::optional<std::string> shortcut = std::nullopt, bool selected = false, bool enabled = true) -> bool
          {
            ...
            return MenuItemSimple_adapt_const_char_pointer_with_default_null(label, shortcut, selected, enabled); }, nb::arg("label"), nb::arg("shortcut") = nb::none(), nb::arg("selected") = false, nb::arg("enabled") = true, "(private API)");
    // #endif
    //

    m.def("menu_item", [](const char *label, const char *shortcut, bool p_selected, bool enabled = true) -> std::tuple<bool, bool>
          {
            ...
            return MenuItem_adapt_modifiable_immutable_to_return(label, shortcut, p_selected, enabled); }, nb::arg("label"), nb::arg("shortcut"), nb::arg("p_selected"), nb::arg("enabled") = true, "return True when activated + toggle (*p_selected) if p_selected != None");
    ...
    m.def("set_tooltip", [](const char *fmt)
          {
            ...
            SetTooltip_adapt_variadic_format(fmt); }, nb::arg("fmt"), "set a text-only tooltip. Often used after a ImGui::IsItemHovered() check. Override any previous call to SetTooltip().");

    m.def("begin_item_tooltip",
          ImGui::BeginItemTooltip, "begin/append a tooltip window if preceding item was hovered.");

    m.def("set_item_tooltip", [](const char *fmt)
          {
            ...
            SetItemTooltip_adapt_variadic_format(fmt); }, nb::arg("fmt"), "set a text-only tooltip if preceding item was hovered. override any previous call to SetTooltip().");
    ...
    m.def("begin_popup_modal", [](const char *name, std::optional<bool> p_open = std::nullopt, ImGuiWindowFlags flags = 0) -> std::tuple<bool, std::optional<bool>>
          {
            ...
            return BeginPopupModal_adapt_modifiable_immutable_to_return(name, p_open, flags); }, nb::arg("name"), nb::arg("p_open") = nb::none(), nb::arg("flags") = 0, "return True if the modal is open, and you can start outputting to it.");
    ...
    m.def("open_popup_on_item_click", [](std::optional<std::string> str_id = std::nullopt, ImGuiPopupFlags popup_flags = 1)
          {
            ...
            OpenPopupOnItemClick_adapt_const_char_pointer_with_default_null(str_id, popup_flags); }, nb::arg("str_id") = nb::none(), nb::arg("popup_flags") = 1, "helper to open popup when clicked on last item. Default to ImGuiPopupFlags_MouseButtonRight == 1. (note: actually triggers on the mouse _released_ event to be consistent with popup behaviors)");

    m.def("close_current_popup",
          nb::overload_cast<>(ImGui::CloseCurrentPopup), "manually close the popup we have begin-ed into.");

    m.def("begin_popup_context_item", [](std::optional<std::string> str_id = std::nullopt, ImGuiPopupFlags popup_flags = 1) -> bool
          {
            ...
            return BeginPopupContextItem_adapt_const_char_pointer_with_default_null(str_id, popup_flags); }, nb::arg("str_id") = nb::none(), nb::arg("popup_flags") = 1, "open+begin popup when clicked on last item. Use str_id==None to associate the popup to previous item. If you want to use that on a non-interactive item such as Text() you need to pass in an explicit ID here. read comments in .cpp!");

    m.def("begin_popup_context_window", [](std::optional<std::string> str_id = std::nullopt, ImGuiPopupFlags popup_flags = 1) -> bool
          {
            ...
            return BeginPopupContextWindow_adapt_const_char_pointer_with_default_null(str_id, popup_flags); }, nb::arg("str_id") = nb::none(), nb::arg("popup_flags") = 1, "open+begin popup when clicked on current window.");

    m.def("begin_popup_context_void", [](std::optional<std::string> str_id = std::nullopt, ImGuiPopupFlags popup_flags = 1) -> bool
          {
            ...
            return BeginPopupContextVoid_adapt_const_char_pointer_with_default_null(str_id, popup_flags); }, nb::arg("str_id") = nb::none(), nb::arg("popup_flags") = 1, "open+begin popup when clicked in None (where there are no windows).");
    ...
    m.def("begin_table", [](const char *str_id, int columns, ImGuiTableFlags flags = 0, const std::optional<const ImVec2> &outer_size = std::nullopt, float inner_width = 0.0f) -> bool
          {
            ...
            return BeginTable_adapt_mutable_param_with_default_value(str_id, columns, flags, outer_size, inner_width); }, nb::arg("str_id"), nb::arg("columns"), nb::arg("flags") = 0, nb::arg("outer_size") = nb::none(), nb::arg("inner_width") = 0.0f, "---\nPython bindings defaults:\n    If outer_size is None, then its default value will be: ImVec2(0.0, 0.0)");
    ...
    m.def("columns", [](int count = 1, std::optional<std::string> id = std::nullopt, bool borders = true)
          {
            ...
            Columns_adapt_const_char_pointer_with_default_null(count, id, borders); }, nb::arg("count") = 1, nb::arg("id_") = nb::none(), nb::arg("borders") = true);
    ...
    m.def("begin_tab_item", [](const char *label, std::optional<bool> p_open = std::nullopt, ImGuiTabItemFlags flags = 0) -> std::tuple<bool, std::optional<bool>>
          {
            ...
            return BeginTabItem_adapt_modifiable_immutable_to_return(label, p_open, flags); }, nb::arg("label"), nb::arg("p_open") = nb::none(), nb::arg("flags") = 0);
    // #ifdef IMGUI_BUNDLE_PYTHON_API
    //
    ...
    m.def("dock_space", [](ImGuiID dockspace_id, const std::optional<const ImVec2> &size = std::nullopt, ImGuiDockNodeFlags flags = 0, const ImGuiWindowClass *window_class = NULL) -> ImGuiID
          {
            ...
            return DockSpace_adapt_mutable_param_with_default_value(dockspace_id, size, flags, window_class); }, nb::arg("dockspace_id"), nb::arg("size") = nb::none(), nb::arg("flags") = 0, nb::arg("window_class") = nb::none(), "---\nPython bindings defaults:\n    If size is None, then its default value will be: ImVec2(0, 0)");
    ...
    m.def("log_to_file", [](int auto_open_depth = -1, std::optional<std::string> filename = std::nullopt)
          {
            ...
            LogToFile_adapt_const_char_pointer_with_default_null(auto_open_depth, filename); }, nb::arg("auto_open_depth") = -1, nb::arg("filename") = nb::none(), "start logging to file");
    ...
    m.def("log_text", [](const char *fmt)
          {
            ...
            LogText_adapt_variadic_format(fmt); }, nb::arg("fmt"), "pass text data straight to log (without being displayed)");
    ...
    m.def("calc_text_size", [](const char *text, std::optional<std::string> text_end = std::nullopt, bool hide_text_after_double_hash = false, float wrap_width = -1.0f) -> ImVec2
          {
            ...
            return CalcTextSize_adapt_const_char_pointer_with_default_null(text, text_end, hide_text_after_double_hash, wrap_width); }, nb::arg("text"), nb::arg("text_end") = nb::none(), nb::arg("hide_text_after_double_hash") = false, nb::arg("wrap_width") = -1.0f, "Text Utilities");
    ...
    m.def("color_convert_rgb_to_hsv", [](float r, float g, float b, float out_h, float out_s, float out_v) -> std::tuple<float, float, float>
          {
            ...
            return ColorConvertRGBtoHSV_adapt_modifiable_immutable_to_return(r, g, b, out_h, out_s, out_v); }, nb::arg("r"), nb::arg("g"), nb::arg("b"), nb::arg("out_h"), nb::arg("out_s"), nb::arg("out_v"));

    m.def("color_convert_hsv_to_rgb", [](float h, float s, float v, float out_r, float out_g, float out_b) -> std::tuple<float, float, float>
          {
            ...
            return ColorConvertHSVtoRGB_adapt_modifiable_immutable_to_return(h, s, v, out_r, out_g, out_b); }, nb::arg("h"), nb::arg("s"), nb::arg("v"), nb::arg("out_r"), nb::arg("out_g"), nb::arg("out_b"));
    ...
    m.def("save_ini_settings_to_memory", []() -> const char *
          {
            ...
            return SaveIniSettingsToMemory_adapt_exclude_params(); }, "return a zero-terminated string with the .ini data which you can save by your own mean. call when io.WantSaveIniSettings is set, then save data by your own mean and clear io.WantSaveIniSettings.", nb::rv_policy::reference);
    ...
    auto pyClassImGuiTableSortSpecs =
        nb::class_<ImGuiTableSortSpecs>(m, "TableSortSpecs", " Sorting specifications for a table (often handling sort specs for a single column, occasionally more)\n Obtained by calling TableGetSortSpecs().\n When 'SpecsDirty == True' you can sort your data. It will be True with sorting specs have changed since last call, or the first time.\n Make sure to set 'SpecsDirty = False' after sorting, else you may wastefully sort your data every frame!")
    ...
    auto pyClassImGuiTableColumnSortSpecs =
        nb::class_<ImGuiTableColumnSortSpecs>(m, "TableColumnSortSpecs", "Sorting specification for one column of a table (sizeof == 12 bytes)")
    ...
    auto pyClassImNewWrapper =
        nb::class_<ImNewWrapper>(m, "ImNewWrapper", "")
            .def(nb::init<>()) // implicit default constructor
        ;

    auto pyClassImVector_int =
        nb::class_<ImVector<int>>(m, "ImVector_int", "")
            // #ifdef IMGUI_BUNDLE_PYTHON_API
            //
            .def("data_address",
            ...
            .def("__iter__", [](const ImVector<int> &v)
                 { return nb::make_iterator(nb::type<ImVector<int>>(), "iterator", v.begin(), v.end()); }, nb::keep_alive<0, 1>())
            .def("__len__", [](const ImVector<int> &v)
                 { return v.size(); });
    auto pyClassImVector_uint =
        nb::class_<ImVector<uint>>(m, "ImVector_uint", "")
            // #ifdef IMGUI_BUNDLE_PYTHON_API
            //
            .def("data_address",
            ...
            .def("__iter__", [](const ImVector<uint> &v)
                 { return nb::make_iterator(nb::type<ImVector<uint>>(), "iterator", v.begin(), v.end()); }, nb::keep_alive<0, 1>())
            .def("__len__", [](const ImVector<uint> &v)
                 { return v.size(); });
    auto pyClassImVector_float =
        nb::class_<ImVector<float>>(m, "ImVector_float", "")
            // #ifdef IMGUI_BUNDLE_PYTHON_API
            //
            .def("data_address",
            ...
            .def("__iter__", [](const ImVector<float> &v)
                 { return nb::make_iterator(nb::type<ImVector<float>>(), "iterator", v.begin(), v.end()); }, nb::keep_alive<0, 1>())
            .def("__len__", [](const ImVector<float> &v)
                 { return v.size(); });
    auto pyClassImVector_char =
        nb::class_<ImVector<char>>(m, "ImVector_char", "")
            // #ifdef IMGUI_BUNDLE_PYTHON_API
            //
            .def("data_address",
            ...
            .def("__iter__", [](const ImVector<char> &v)
                 { return nb::make_iterator(nb::type<ImVector<char>>(), "iterator", v.begin(), v.end()); }, nb::keep_alive<0, 1>())
            .def("__len__", [](const ImVector<char> &v)
                 { return v.size(); });
    auto pyClassImVector_uchar =
        nb::class_<ImVector<uchar>>(m, "ImVector_uchar", "")
            // #ifdef IMGUI_BUNDLE_PYTHON_API
            //
            .def("data_address",
            ...
            .def("__iter__", [](const ImVector<uchar> &v)
                 { return nb::make_iterator(nb::type<ImVector<uchar>>(), "iterator", v.begin(), v.end()); }, nb::keep_alive<0, 1>())
            .def("__len__", [](const ImVector<uchar> &v)
                 { return v.size(); });
    auto pyClassImVector_ImDrawCmd =
        nb::class_<ImVector<ImDrawCmd>>(m, "ImVector_ImDrawCmd", "")
            // #ifdef IMGUI_BUNDLE_PYTHON_API
            //
            .def("data_address",
            ...
            .def("__iter__", [](const ImVector<ImDrawCmd> &v)
                 { return nb::make_iterator(nb::type<ImVector<ImDrawCmd>>(), "iterator", v.begin(), v.end()); }, nb::keep_alive<0, 1>())
            .def("__len__", [](const ImVector<ImDrawCmd> &v)
                 { return v.size(); });
    auto pyClassImVector_ImDrawChannel =
        nb::class_<ImVector<ImDrawChannel>>(m, "ImVector_ImDrawChannel", "")
            // #ifdef IMGUI_BUNDLE_PYTHON_API
            //
            .def("data_address",
            ...
            .def("__iter__", [](const ImVector<ImDrawChannel> &v)
                 { return nb::make_iterator(nb::type<ImVector<ImDrawChannel>>(), "iterator", v.begin(), v.end()); }, nb::keep_alive<0, 1>())
            .def("__len__", [](const ImVector<ImDrawChannel> &v)
                 { return v.size(); });
    auto pyClassImVector_ImDrawVert =
        nb::class_<ImVector<ImDrawVert>>(m, "ImVector_ImDrawVert", "")
            // #ifdef IMGUI_BUNDLE_PYTHON_API
            //
            .def("data_address",
            ...
            .def("__iter__", [](const ImVector<ImDrawVert> &v)
                 { return nb::make_iterator(nb::type<ImVector<ImDrawVert>>(), "iterator", v.begin(), v.end()); }, nb::keep_alive<0, 1>())
            .def("__len__", [](const ImVector<ImDrawVert> &v)
                 { return v.size(); });
    auto pyClassImVector_ImVec4 =
        nb::class_<ImVector<ImVec4>>(m, "ImVector_ImVec4", "")
            // #ifdef IMGUI_BUNDLE_PYTHON_API
            //
            .def("data_address",
            ...
            .def("__iter__", [](const ImVector<ImVec4> &v)
                 { return nb::make_iterator(nb::type<ImVector<ImVec4>>(), "iterator", v.begin(), v.end()); }, nb::keep_alive<0, 1>())
            .def("__len__", [](const ImVector<ImVec4> &v)
                 { return v.size(); });
    auto pyClassImVector_ImVec2 =
        nb::class_<ImVector<ImVec2>>(m, "ImVector_ImVec2", "")
            // #ifdef IMGUI_BUNDLE_PYTHON_API
            //
            .def("data_address",
            ...
            .def("__iter__", [](const ImVector<ImVec2> &v)
                 { return nb::make_iterator(nb::type<ImVector<ImVec2>>(), "iterator", v.begin(), v.end()); }, nb::keep_alive<0, 1>())
            .def("__len__", [](const ImVector<ImVec2> &v)
                 { return v.size(); });
    auto pyClassImVector_ImDrawList_ptr =
        nb::class_<ImVector<ImDrawList *>>(m, "ImVector_ImDrawList_ptr", "")
            // #ifdef IMGUI_BUNDLE_PYTHON_API
            //
            .def("data_address",
            ...
            .def("__iter__", [](const ImVector<ImDrawList *> &v)
                 { return nb::make_iterator(nb::type<ImVector<ImDrawList *>>(), "iterator", v.begin(), v.end()); }, nb::keep_alive<0, 1>())
            .def("__len__", [](const ImVector<ImDrawList *> &v)
                 { return v.size(); });
    auto pyClassImVector_ImFont_ptr =
        nb::class_<ImVector<ImFont *>>(m, "ImVector_ImFont_ptr", "")
            // #ifdef IMGUI_BUNDLE_PYTHON_API
            //
            .def("data_address",
            ...
            .def("__iter__", [](const ImVector<ImFont *> &v)
                 { return nb::make_iterator(nb::type<ImVector<ImFont *>>(), "iterator", v.begin(), v.end()); }, nb::keep_alive<0, 1>())
            .def("__len__", [](const ImVector<ImFont *> &v)
                 { return v.size(); });
    auto pyClassImVector_ImFontGlyph =
        nb::class_<ImVector<ImFontGlyph>>(m, "ImVector_ImFontGlyph", "")
            // #ifdef IMGUI_BUNDLE_PYTHON_API
            //
            .def("data_address",
            ...
            .def("__iter__", [](const ImVector<ImFontGlyph> &v)
                 { return nb::make_iterator(nb::type<ImVector<ImFontGlyph>>(), "iterator", v.begin(), v.end()); }, nb::keep_alive<0, 1>())
            .def("__len__", [](const ImVector<ImFontGlyph> &v)
                 { return v.size(); });
    auto pyClassImVector_ImGuiPlatformMonitor =
        nb::class_<ImVector<ImGuiPlatformMonitor>>(m, "ImVector_PlatformMonitor", "")
            // #ifdef IMGUI_BUNDLE_PYTHON_API
            //
            .def("data_address",
            ...
            .def("__iter__", [](const ImVector<ImGuiPlatformMonitor> &v)
                 { return nb::make_iterator(nb::type<ImVector<ImGuiPlatformMonitor>>(), "iterator", v.begin(), v.end()); }, nb::keep_alive<0, 1>())
            .def("__len__", [](const ImVector<ImGuiPlatformMonitor> &v)
                 { return v.size(); });
    auto pyClassImVector_ImGuiViewport_ptr =
        nb::class_<ImVector<ImGuiViewport *>>(m, "ImVector_Viewport_ptr", "")
            // #ifdef IMGUI_BUNDLE_PYTHON_API
            //
            .def("data_address",
            ...
            .def("__iter__", [](const ImVector<ImGuiViewport *> &v)
                 { return nb::make_iterator(nb::type<ImVector<ImGuiViewport *>>(), "iterator", v.begin(), v.end()); }, nb::keep_alive<0, 1>())
            .def("__len__", [](const ImVector<ImGuiViewport *> &v)
                 { return v.size(); });
    auto pyClassImVector_ImGuiWindow_ptr =
        nb::class_<ImVector<ImGuiWindow *>>(m, "ImVector_Window_ptr", "")
            // #ifdef IMGUI_BUNDLE_PYTHON_API
            //
            .def("data_address",
            ...
            .def("__iter__", [](const ImVector<ImGuiWindow *> &v)
                 { return nb::make_iterator(nb::type<ImVector<ImGuiWindow *>>(), "iterator", v.begin(), v.end()); }, nb::keep_alive<0, 1>())
            .def("__len__", [](const ImVector<ImGuiWindow *> &v)
                 { return v.size(); });
    auto pyClassImVector_ImFontAtlasCustomRect =
        nb::class_<ImVector<ImFontAtlasCustomRect>>(m, "ImVector_ImFontAtlasCustomRect", "")
            // #ifdef IMGUI_BUNDLE_PYTHON_API
            //
            .def("data_address",
            ...
            .def("__iter__", [](const ImVector<ImFontAtlasCustomRect> &v)
                 { return nb::make_iterator(nb::type<ImVector<ImFontAtlasCustomRect>>(), "iterator", v.begin(), v.end()); }, nb::keep_alive<0, 1>())
            .def("__len__", [](const ImVector<ImFontAtlasCustomRect> &v)
                 { return v.size(); });
    auto pyClassImVector_ImFontConfig =
        nb::class_<ImVector<ImFontConfig>>(m, "ImVector_ImFontConfig", "")
            // #ifdef IMGUI_BUNDLE_PYTHON_API
            //
            .def("data_address",
            ...
            .def("__iter__", [](const ImVector<ImFontConfig> &v)
                 { return nb::make_iterator(nb::type<ImVector<ImFontConfig>>(), "iterator", v.begin(), v.end()); }, nb::keep_alive<0, 1>())
            .def("__len__", [](const ImVector<ImFontConfig> &v)
                 { return v.size(); });
    auto pyClassImVector_ImGuiFocusScopeData =
        nb::class_<ImVector<ImGuiFocusScopeData>>(m, "ImVector_FocusScopeData", "")
            // #ifdef IMGUI_BUNDLE_PYTHON_API
            //
            .def("data_address",
            ...
            .def("__iter__", [](const ImVector<ImGuiFocusScopeData> &v)
                 { return nb::make_iterator(nb::type<ImVector<ImGuiFocusScopeData>>(), "iterator", v.begin(), v.end()); }, nb::keep_alive<0, 1>())
            .def("__len__", [](const ImVector<ImGuiFocusScopeData> &v)
                 { return v.size(); });
    auto pyClassImVector_ImGuiSelectionRequest =
        nb::class_<ImVector<ImGuiSelectionRequest>>(m, "ImVector_SelectionRequest", "")
            // #ifdef IMGUI_BUNDLE_PYTHON_API
            //
            .def("data_address",
            ...
            .def("__iter__", [](const ImVector<ImGuiSelectionRequest> &v)
                 { return nb::make_iterator(nb::type<ImVector<ImGuiSelectionRequest>>(), "iterator", v.begin(), v.end()); }, nb::keep_alive<0, 1>())
            .def("__len__", [](const ImVector<ImGuiSelectionRequest> &v)
                 { return v.size(); });
    auto pyClassImVector_ImRect =
        nb::class_<ImVector<ImRect>>(m, "ImVector_ImRect", "")
            // #ifdef IMGUI_BUNDLE_PYTHON_API
            //
            .def("data_address",
            ...
            .def("__iter__", [](const ImVector<ImRect> &v)
                 { return nb::make_iterator(nb::type<ImVector<ImRect>>(), "iterator", v.begin(), v.end()); }, nb::keep_alive<0, 1>())
            .def("__len__", [](const ImVector<ImRect> &v)
                 { return v.size(); });
    auto pyClassImVector_ImGuiColorMod =
        nb::class_<ImVector<ImGuiColorMod>>(m, "ImVector_ColorMod", "")
            // #ifdef IMGUI_BUNDLE_PYTHON_API
            //
            .def("data_address",
            ...
            .def("__iter__", [](const ImVector<ImGuiColorMod> &v)
                 { return nb::make_iterator(nb::type<ImVector<ImGuiColorMod>>(), "iterator", v.begin(), v.end()); }, nb::keep_alive<0, 1>())
            .def("__len__", [](const ImVector<ImGuiColorMod> &v)
                 { return v.size(); });
    auto pyClassImVector_ImGuiGroupData =
        nb::class_<ImVector<ImGuiGroupData>>(m, "ImVector_GroupData", "")
            // #ifdef IMGUI_BUNDLE_PYTHON_API
            //
            .def("data_address",
            ...
            .def("__iter__", [](const ImVector<ImGuiGroupData> &v)
                 { return nb::make_iterator(nb::type<ImVector<ImGuiGroupData>>(), "iterator", v.begin(), v.end()); }, nb::keep_alive<0, 1>())
            .def("__len__", [](const ImVector<ImGuiGroupData> &v)
                 { return v.size(); });
    auto pyClassImVector_ImGuiPopupData =
        nb::class_<ImVector<ImGuiPopupData>>(m, "ImVector_PopupData", "")
            // #ifdef IMGUI_BUNDLE_PYTHON_API
            //
            .def("data_address",
            ...
            .def("__iter__", [](const ImVector<ImGuiPopupData> &v)
                 { return nb::make_iterator(nb::type<ImVector<ImGuiPopupData>>(), "iterator", v.begin(), v.end()); }, nb::keep_alive<0, 1>())
            .def("__len__", [](const ImVector<ImGuiPopupData> &v)
                 { return v.size(); });
    auto pyClassImVector_ImGuiViewportP_ptr =
        nb::class_<ImVector<ImGuiViewportP *>>(m, "ImVector_ViewportP_ptr", "")
            // #ifdef IMGUI_BUNDLE_PYTHON_API
            //
            .def("data_address",
            ...
            .def("__iter__", [](const ImVector<ImGuiViewportP *> &v)
                 { return nb::make_iterator(nb::type<ImVector<ImGuiViewportP *>>(), "iterator", v.begin(), v.end()); }, nb::keep_alive<0, 1>())
            .def("__len__", [](const ImVector<ImGuiViewportP *> &v)
                 { return v.size(); });
    auto pyClassImVector_ImGuiInputEvent =
        nb::class_<ImVector<ImGuiInputEvent>>(m, "ImVector_InputEvent", "")
            // #ifdef IMGUI_BUNDLE_PYTHON_API
            //
            .def("data_address",
            ...
            .def("__iter__", [](const ImVector<ImGuiInputEvent> &v)
                 { return nb::make_iterator(nb::type<ImVector<ImGuiInputEvent>>(), "iterator", v.begin(), v.end()); }, nb::keep_alive<0, 1>())
            .def("__len__", [](const ImVector<ImGuiInputEvent> &v)
                 { return v.size(); });
    auto pyClassImVector_ImGuiWindowStackData =
        nb::class_<ImVector<ImGuiWindowStackData>>(m, "ImVector_WindowStackData", "")
            // #ifdef IMGUI_BUNDLE_PYTHON_API
            //
            .def("data_address",
            ...
            .def("__iter__", [](const ImVector<ImGuiWindowStackData> &v)
                 { return nb::make_iterator(nb::type<ImVector<ImGuiWindowStackData>>(), "iterator", v.begin(), v.end()); }, nb::keep_alive<0, 1>())
            .def("__len__", [](const ImVector<ImGuiWindowStackData> &v)
                 { return v.size(); });
    auto pyClassImVector_ImGuiTableColumnSortSpecs =
        nb::class_<ImVector<ImGuiTableColumnSortSpecs>>(m, "ImVector_TableColumnSortSpecs", "")
            // #ifdef IMGUI_BUNDLE_PYTHON_API
            //
            .def("data_address",
            ...
            .def("__iter__", [](const ImVector<ImGuiTableColumnSortSpecs> &v)
                 { return nb::make_iterator(nb::type<ImVector<ImGuiTableColumnSortSpecs>>(), "iterator", v.begin(), v.end()); }, nb::keep_alive<0, 1>())
            .def("__len__", [](const ImVector<ImGuiTableColumnSortSpecs> &v)
                 { return v.size(); });
    auto pyClassImVector_ImGuiTableInstanceData =
        nb::class_<ImVector<ImGuiTableInstanceData>>(m, "ImVector_TableInstanceData", "")
            // #ifdef IMGUI_BUNDLE_PYTHON_API
            //
            .def("data_address",
            ...
            .def("__iter__", [](const ImVector<ImGuiTableInstanceData> &v)
                 { return nb::make_iterator(nb::type<ImVector<ImGuiTableInstanceData>>(), "iterator", v.begin(), v.end()); }, nb::keep_alive<0, 1>())
            .def("__len__", [](const ImVector<ImGuiTableInstanceData> &v)
                 { return v.size(); });
    auto pyClassImVector_ImGuiTableTempData =
        nb::class_<ImVector<ImGuiTableTempData>>(m, "ImVector_TableTempData", "")
            // #ifdef IMGUI_BUNDLE_PYTHON_API
            //
            .def("data_address",
            ...
            .def("__iter__", [](const ImVector<ImGuiTableTempData> &v)
                 { return nb::make_iterator(nb::type<ImVector<ImGuiTableTempData>>(), "iterator", v.begin(), v.end()); }, nb::keep_alive<0, 1>())
            .def("__len__", [](const ImVector<ImGuiTableTempData> &v)
                 { return v.size(); });
    auto pyClassImVector_ImGuiPtrOrIndex =
        nb::class_<ImVector<ImGuiPtrOrIndex>>(m, "ImVector_PtrOrIndex", "")
            // #ifdef IMGUI_BUNDLE_PYTHON_API
            //
            .def("data_address",
            ...
            .def("__iter__", [](const ImVector<ImGuiPtrOrIndex> &v)
                 { return nb::make_iterator(nb::type<ImVector<ImGuiPtrOrIndex>>(), "iterator", v.begin(), v.end()); }, nb::keep_alive<0, 1>())
            .def("__len__", [](const ImVector<ImGuiPtrOrIndex> &v)
                 { return v.size(); });
    auto pyClassImVector_ImGuiSettingsHandler =
        nb::class_<ImVector<ImGuiSettingsHandler>>(m, "ImVector_SettingsHandler", "")
            // #ifdef IMGUI_BUNDLE_PYTHON_API
            //
            .def("data_address",
            ...
            .def("__iter__", [](const ImVector<ImGuiSettingsHandler> &v)
                 { return nb::make_iterator(nb::type<ImVector<ImGuiSettingsHandler>>(), "iterator", v.begin(), v.end()); }, nb::keep_alive<0, 1>())
            .def("__len__", [](const ImVector<ImGuiSettingsHandler> &v)
                 { return v.size(); });
    auto pyClassImVector_ImGuiShrinkWidthItem =
        nb::class_<ImVector<ImGuiShrinkWidthItem>>(m, "ImVector_ShrinkWidthItem", "")
            // #ifdef IMGUI_BUNDLE_PYTHON_API
            //
            .def("data_address",
            ...
            .def("__iter__", [](const ImVector<ImGuiShrinkWidthItem> &v)
                 { return nb::make_iterator(nb::type<ImVector<ImGuiShrinkWidthItem>>(), "iterator", v.begin(), v.end()); }, nb::keep_alive<0, 1>())
            .def("__len__", [](const ImVector<ImGuiShrinkWidthItem> &v)
                 { return v.size(); });
    auto pyClassImVector_ImGuiStackLevelInfo =
        nb::class_<ImVector<ImGuiStackLevelInfo>>(m, "ImVector_StackLevelInfo", "")
            // #ifdef IMGUI_BUNDLE_PYTHON_API
            //
            .def("data_address",
            ...
            .def("__iter__", [](const ImVector<ImGuiStackLevelInfo> &v)
                 { return nb::make_iterator(nb::type<ImVector<ImGuiStackLevelInfo>>(), "iterator", v.begin(), v.end()); }, nb::keep_alive<0, 1>())
            .def("__len__", [](const ImVector<ImGuiStackLevelInfo> &v)
                 { return v.size(); });
    auto pyClassImVector_ImGuiTabItem =
        nb::class_<ImVector<ImGuiTabItem>>(m, "ImVector_TabItem", "")
            // #ifdef IMGUI_BUNDLE_PYTHON_API
            //
            .def("data_address",
            ...
            .def("__iter__", [](const ImVector<ImGuiTabItem> &v)
                 { return nb::make_iterator(nb::type<ImVector<ImGuiTabItem>>(), "iterator", v.begin(), v.end()); }, nb::keep_alive<0, 1>())
            .def("__len__", [](const ImVector<ImGuiTabItem> &v)
                 { return v.size(); });
    auto pyClassImVector_ImGuiKeyRoutingData =
        nb::class_<ImVector<ImGuiKeyRoutingData>>(m, "ImVector_KeyRoutingData", "")
            // #ifdef IMGUI_BUNDLE_PYTHON_API
            //
            .def("data_address",
            ...
            .def("__iter__", [](const ImVector<ImGuiKeyRoutingData> &v)
                 { return nb::make_iterator(nb::type<ImVector<ImGuiKeyRoutingData>>(), "iterator", v.begin(), v.end()); }, nb::keep_alive<0, 1>())
            .def("__len__", [](const ImVector<ImGuiKeyRoutingData> &v)
                 { return v.size(); });
    auto pyClassImVector_ImGuiListClipperData =
        nb::class_<ImVector<ImGuiListClipperData>>(m, "ImVector_ListClipperData", "")
            // #ifdef IMGUI_BUNDLE_PYTHON_API
            //
            .def("data_address",
            ...
            .def("__iter__", [](const ImVector<ImGuiListClipperData> &v)
                 { return nb::make_iterator(nb::type<ImVector<ImGuiListClipperData>>(), "iterator", v.begin(), v.end()); }, nb::keep_alive<0, 1>())
            .def("__len__", [](const ImVector<ImGuiListClipperData> &v)
                 { return v.size(); });
    auto pyClassImVector_ImGuiListClipperRange =
        nb::class_<ImVector<ImGuiListClipperRange>>(m, "ImVector_ListClipperRange", "")
            // #ifdef IMGUI_BUNDLE_PYTHON_API
            //
            .def("data_address",
            ...
            .def("__iter__", [](const ImVector<ImGuiListClipperRange> &v)
                 { return nb::make_iterator(nb::type<ImVector<ImGuiListClipperRange>>(), "iterator", v.begin(), v.end()); }, nb::keep_alive<0, 1>())
            .def("__len__", [](const ImVector<ImGuiListClipperRange> &v)
                 { return v.size(); });
    auto pyClassImVector_ImGuiOldColumnData =
        nb::class_<ImVector<ImGuiOldColumnData>>(m, "ImVector_OldColumnData", "")
            // #ifdef IMGUI_BUNDLE_PYTHON_API
            //
            .def("data_address",
            ...
            .def("__iter__", [](const ImVector<ImGuiOldColumnData> &v)
                 { return nb::make_iterator(nb::type<ImVector<ImGuiOldColumnData>>(), "iterator", v.begin(), v.end()); }, nb::keep_alive<0, 1>())
            .def("__len__", [](const ImVector<ImGuiOldColumnData> &v)
                 { return v.size(); });
    auto pyClassImVector_ImGuiOldColumns =
        nb::class_<ImVector<ImGuiOldColumns>>(m, "ImVector_OldColumns", "")
            // #ifdef IMGUI_BUNDLE_PYTHON_API
            //
            .def("data_address",
            ...
            .def("__iter__", [](const ImVector<ImGuiOldColumns> &v)
                 { return nb::make_iterator(nb::type<ImVector<ImGuiOldColumns>>(), "iterator", v.begin(), v.end()); }, nb::keep_alive<0, 1>())
            .def("__len__", [](const ImVector<ImGuiOldColumns> &v)
                 { return v.size(); });
    auto pyClassImVector_ImGuiStyleMod =
        nb::class_<ImVector<ImGuiStyleMod>>(m, "ImVector_StyleMod", "")
            // #ifdef IMGUI_BUNDLE_PYTHON_API
            //
            .def("data_address",
            ...
            .def("__iter__", [](const ImVector<ImGuiStyleMod> &v)
                 { return nb::make_iterator(nb::type<ImVector<ImGuiStyleMod>>(), "iterator", v.begin(), v.end()); }, nb::keep_alive<0, 1>())
            .def("__len__", [](const ImVector<ImGuiStyleMod> &v)
                 { return v.size(); });
    auto pyClassImVector_ImGuiTableHeaderData =
        nb::class_<ImVector<ImGuiTableHeaderData>>(m, "ImVector_TableHeaderData", "")
            // #ifdef IMGUI_BUNDLE_PYTHON_API
            //
            .def("data_address",
            ...
            .def("__iter__", [](const ImVector<ImGuiTableHeaderData> &v)
                 { return nb::make_iterator(nb::type<ImVector<ImGuiTableHeaderData>>(), "iterator", v.begin(), v.end()); }, nb::keep_alive<0, 1>())
            .def("__len__", [](const ImVector<ImGuiTableHeaderData> &v)
                 { return v.size(); });
    auto pyClassImVector_ImGuiTreeNodeStackData =
        nb::class_<ImVector<ImGuiTreeNodeStackData>>(m, "ImVector_TreeNodeStackData", "")
            // #ifdef IMGUI_BUNDLE_PYTHON_API
            //
            .def("data_address",
            ...
            .def("__iter__", [](const ImVector<ImGuiTreeNodeStackData> &v)
                 { return nb::make_iterator(nb::type<ImVector<ImGuiTreeNodeStackData>>(), "iterator", v.begin(), v.end()); }, nb::keep_alive<0, 1>())
            .def("__len__", [](const ImVector<ImGuiTreeNodeStackData> &v)
                 { return v.size(); });
    auto pyClassImVector_ImGuiMultiSelectTempData =
        nb::class_<ImVector<ImGuiMultiSelectTempData>>(m, "ImVector_MultiSelectTempData", "")
            // #ifdef IMGUI_BUNDLE_PYTHON_API
            //
            .def("data_address",
            ...
            .def("__iter__", [](const ImVector<ImGuiMultiSelectTempData> &v)
                 { return nb::make_iterator(nb::type<ImVector<ImGuiMultiSelectTempData>>(), "iterator", v.begin(), v.end()); }, nb::keep_alive<0, 1>())
            .def("__len__", [](const ImVector<ImGuiMultiSelectTempData> &v)
                 { return v.size(); });
    ...
    auto pyClassImGuiKeyData =
        nb::class_<ImGuiKeyData>(m, "KeyData", " [Internal] Storage used by IsKeyDown(), IsKeyPressed() etc functions.\n If prior to 1.87 you used io.KeysDownDuration[] (which was marked as internal), you should use GetKeyData(key)->DownDuration and *NOT* io.KeysData[key]->DownDuration.")
            ...
            r->AnalogValue = AnalogValue; }, nb::arg("down") = bool(), nb::arg("down_duration") = float(), nb::arg("down_duration_prev") = float(), nb::arg("analog_value") = float())
    ...
    auto pyClassImGuiIO =
        nb::class_<ImGuiIO>(m, "IO", "")
            ...
            .def_prop_ro("mouse_down", [](ImGuiIO &self) -> nb::ndarray<bool, nb::numpy, nb::shape<5>, nb::c_contig>
                         { return self.MouseDown; }, "Mouse buttons: 0=left, 1=right, 2=middle + extras (ImGuiMouseButton_COUNT == 5). Dear ImGui mostly uses left and right buttons. Other buttons allow us to track if the mouse is being used by your application + available to user as a convenience via IsMouse** API.")
            ...
            .def_prop_ro("mouse_clicked_time", [](ImGuiIO &self) -> nb::ndarray<double, nb::numpy, nb::shape<5>, nb::c_contig>
                         { return self.MouseClickedTime; }, "Time of last click (used to figure out double-click)")
            .def_prop_ro("mouse_clicked", [](ImGuiIO &self) -> nb::ndarray<bool, nb::numpy, nb::shape<5>, nb::c_contig>
                         { return self.MouseClicked; }, "Mouse button went from !Down to Down (same as MouseClickedCount[x] != 0)")
            .def_prop_ro("mouse_double_clicked", [](ImGuiIO &self) -> nb::ndarray<bool, nb::numpy, nb::shape<5>, nb::c_contig>
                         { return self.MouseDoubleClicked; }, "Has mouse button been double-clicked? (same as MouseClickedCount[x] == 2)")
            .def_prop_ro("mouse_clicked_count", [](ImGuiIO &self) -> nb::ndarray<ImU16, nb::numpy, nb::shape<5>, nb::c_contig>
                         { return self.MouseClickedCount; }, "== 0 (not clicked), == 1 (same as MouseClicked[]), == 2 (double-clicked), == 3 (triple-clicked) etc. when going from !Down to Down")
            .def_prop_ro("mouse_clicked_last_count", [](ImGuiIO &self) -> nb::ndarray<ImU16, nb::numpy, nb::shape<5>, nb::c_contig>
                         { return self.MouseClickedLastCount; }, "Count successive number of clicks. Stays valid after mouse release. Reset after another click is done.")
            .def_prop_ro("mouse_released", [](ImGuiIO &self) -> nb::ndarray<bool, nb::numpy, nb::shape<5>, nb::c_contig>
                         { return self.MouseReleased; }, "Mouse button went from Down to !Down")
            .def_prop_ro("mouse_down_owned", [](ImGuiIO &self) -> nb::ndarray<bool, nb::numpy, nb::shape<5>, nb::c_contig>
                         { return self.MouseDownOwned; }, "Track if button was clicked inside a dear imgui window or over None blocked by a popup. We don't request mouse capture from the application if click started outside ImGui bounds.")
            .def_prop_ro("mouse_down_owned_unless_popup_close", [](ImGuiIO &self) -> nb::ndarray<bool, nb::numpy, nb::shape<5>, nb::c_contig>
                         { return self.MouseDownOwnedUnlessPopupClose; }, "Track if button was clicked inside a dear imgui window.")
            ...
            .def_prop_ro("mouse_down_duration", [](ImGuiIO &self) -> nb::ndarray<float, nb::numpy, nb::shape<5>, nb::c_contig>
                         { return self.MouseDownDuration; }, "Duration the mouse button has been down (0.0 == just clicked)")
            .def_prop_ro("mouse_down_duration_prev", [](ImGuiIO &self) -> nb::ndarray<float, nb::numpy, nb::shape<5>, nb::c_contig>
                         { return self.MouseDownDurationPrev; }, "Previous time the mouse button has been down")
            .def_prop_ro("mouse_drag_max_distance_sqr", [](ImGuiIO &self) -> nb::ndarray<float, nb::numpy, nb::shape<5>, nb::c_contig>
                         { return self.MouseDragMaxDistanceSqr; }, "Squared maximum distance of how much mouse has traveled from the clicking point (used for moving thresholds)")
            ...
            // #ifdef IMGUI_BUNDLE_PYTHON_API
            //
            .def("set_ini_filename", &ImGuiIO::SetIniFilename, nb::arg("filename"))
            .def("set_log_filename", &ImGuiIO::SetLogFilename, nb::arg("filename"))
            .def("get_ini_filename", &ImGuiIO::GetIniFilename)
            .def("get_log_filename", &ImGuiIO::GetLogFilename)
        // #endif
        //
        ;

    auto pyClassImGuiInputTextCallbackData =
        nb::class_<ImGuiInputTextCallbackData>(m, "InputTextCallbackData", " Shared state of InputText(), passed as an argument to your callback when a ImGuiInputTextFlags_Callback* flag is used.\n The callback function should return 0 by default.\n Callbacks (follow a flag name and see comments in ImGuiInputTextFlags_ declarations for more details)\n - ImGuiInputTextFlags_CallbackEdit:        Callback on buffer edit (note that InputText() already returns True on edit, the callback is useful mainly to manipulate the underlying buffer while focus is active)\n - ImGuiInputTextFlags_CallbackAlways:      Callback on each iteration\n - ImGuiInputTextFlags_CallbackCompletion:  Callback on pressing TAB\n - ImGuiInputTextFlags_CallbackHistory:     Callback on pressing Up/Down arrows\n - ImGuiInputTextFlags_CallbackCharFilter:  Callback on character inputs to replace or discard them. Modify 'EventChar' to replace or discard, or return 1 in callback to discard.\n - ImGuiInputTextFlags_CallbackResize:      Callback on buffer capacity changes request (beyond 'buf_size' parameter value), allowing the string to grow.")
            ...
            .def("insert_chars", [](ImGuiInputTextCallbackData &self, int pos, const char *text, std::optional<std::string> text_end = std::nullopt)
                 {
                ...
                InsertChars_adapt_const_char_pointer_with_default_null(pos, text, text_end); }, nb::arg("pos"), nb::arg("text"), nb::arg("text_end") = nb::none())
            .def("select_all", &ImGuiInputTextCallbackData::SelectAll, "(private API)")
            .def("clear_selection", &ImGuiInputTextCallbackData::ClearSelection, "(private API)")
            .def("has_selection", &ImGuiInputTextCallbackData::HasSelection, "(private API)");

    auto pyClassImGuiSizeCallbackData =
        nb::class_<ImGuiSizeCallbackData>(m, "SizeCallbackData", " Resizing callback data to apply custom constraint. As enabled by SetNextWindowSizeConstraints(). Callback is called during the next Begin().\n NB: For basic min/max size constraint on each axis you don't need to use the callback! The SetNextWindowSizeConstraints() parameters are enough.")
            ...
            if (DesiredSize.has_value())
                ...
                r->DesiredSize = ImVec2(); }, nb::arg("pos") = nb::none(), nb::arg("current_size") = nb::none(), nb::arg("desired_size") = nb::none())
    ...
    auto pyClassImGuiWindowClass =
        nb::class_<ImGuiWindowClass>(m, "WindowClass", " [ALPHA] Rarely used / very advanced uses only. Use with SetNextWindowClass() and DockSpace() functions.\n Important: the content of this class is still highly WIP and likely to change and be refactored\n before we stabilize Docking features. Please be mindful if using this.\n Provide hints:\n - To the platform backend via altered viewport flags (enable/disable OS decoration, OS task bar icons, etc.)\n - To the platform backend for OS level parent/child relationships of viewport.\n - To the docking system for various options and filtering.")
    ...
    auto pyClassImGuiPayload =
        nb::class_<ImGuiPayload>(m, "Payload", "Data payload for Drag and Drop operations: AcceptDragDropPayload(), GetDragDropPayload()")
    ...
    auto pyClassImGuiOnceUponAFrame =
        nb::class_<ImGuiOnceUponAFrame>(m, "OnceUponAFrame", " Helper: Execute a block of code at maximum once a frame. Convenient if you want to quickly create a UI within deep-nested code that runs multiple times every frame.\n Usage: static ImGuiOnceUponAFrame oaf; if (oaf) ImGui::Text(\"This will be called only once per frame\");")
            .def(nb::init<>())
    ...
    auto pyClassImGuiTextFilter =
        nb::class_<ImGuiTextFilter>(m, "TextFilter", "Helper: Parse and apply text filters. In format \"aaaaa[,bbbb][,ccccc]\"");

    { // inner classes & enums of TextFilter
        auto pyClassImGuiTextFilter_ClassImGuiTextRange =
            nb::class_<ImGuiTextFilter::ImGuiTextRange>(pyClassImGuiTextFilter, "TextRange", "[Internal]")
    ...
    pyClassImGuiTextFilter
        ...
        .def("pass_filter", [](const ImGuiTextFilter &self, const char *text, std::optional<std::string> text_end = std::nullopt) -> bool
             {
                ...
                return PassFilter_adapt_const_char_pointer_with_default_null(text, text_end); }, nb::arg("text"), nb::arg("text_end") = nb::none())
        .def("build", &ImGuiTextFilter::Build)
        .def("clear", &ImGuiTextFilter::Clear, "(private API)")
        .def("is_active", &ImGuiTextFilter::IsActive, "(private API)")
        .def_rw("count_grep", &ImGuiTextFilter::CountGrep, "");

    auto pyClassImGuiTextBuffer =
        nb::class_<ImGuiTextBuffer>(m, "TextBuffer", " Helper: Growable text buffer for logging/accumulating text\n (this could be called 'ImGuiTextBuilder' / 'ImGuiStringBuilder')")
            ...
            .def("c_str",
                 ...
                 "(private API)",
                 nb::rv_policy::reference)
            .def("append", [](ImGuiTextBuffer &self, const char *str, std::optional<std::string> str_end = std::nullopt)
                 {
                ...
                append_adapt_const_char_pointer_with_default_null(str, str_end); }, nb::arg("str"), nb::arg("str_end") = nb::none())
            .def("appendf", [](ImGuiTextBuffer &self, const char *fmt)
                 {
                ...
                appendf_adapt_variadic_format(fmt); }, nb::arg("fmt"));

    auto pyClassImGuiStoragePair =
        nb::class_<ImGuiStoragePair>(m, "StoragePair", "[Internal] Key+Value for ImGuiStorage")
    ...
    auto pyClassImColor =
        nb::class_<ImColor>(m, "ImColor", " Helper: ImColor() implicitly converts colors to either ImU32 (packed 4x1 byte) or ImVec4 (4x1 float)\n Prefer using IM_COL32() macros if you want a guaranteed compile-time ImU32 for usage with ImDrawList API.\n **Avoid storing ImColor! Store either u32 of ImVec4. This is not a full-featured color class. MAY OBSOLETE.\n **None of the ImGui API are using ImColor directly but you can use it as a convenience to pass colors in either ImU32 or ImVec4 formats. Explicitly cast to ImU32 or ImVec4 if needed.")
    ...
    auto pyClassImGuiMultiSelectIO =
        nb::class_<ImGuiMultiSelectIO>(m, "MultiSelectIO", " Main IO structure returned by BeginMultiSelect()/EndMultiSelect().\n This mainly contains a list of selection requests.\n - Use 'Demo->Tools->Debug Log->Selection' to see requests as they happen.\n - Some fields are only useful if your list is dynamic and allows deletion (getting post-deletion focus/state right is shown in the demo)\n - Below: who reads/writes each fields? 'r'=read, 'w'=write, 'ms'=multi-select code, 'app'=application/user code.")
            ...
            r->ItemsCount = ItemsCount; }, nb::arg("requests") = nb::none(), nb::arg("range_src_item") = nb::none(), nb::arg("nav_id_item") = nb::none(), nb::arg("nav_id_selected") = bool(), nb::arg("range_src_reset") = bool(), nb::arg("items_count") = int())
    ...
    auto pyClassImGuiSelectionRequest =
        nb::class_<ImGuiSelectionRequest>(m, "SelectionRequest", "Selection request item")
            ...
            if (RangeLastItem.has_value())
                ...
                r->RangeLastItem = ImGuiSelectionUserData(); }, nb::arg("type") = ImGuiSelectionRequestType(), nb::arg("selected") = bool(), nb::arg("range_direction") = ImS8(), nb::arg("range_first_item") = nb::none(), nb::arg("range_last_item") = nb::none())
    ...
    auto pyClassImGuiSelectionBasicStorage =
        nb::class_<ImGuiSelectionBasicStorage>(m, "SelectionBasicStorage", " Optional helper to store multi-selection state + apply multi-selection requests.\n - Used by our demos and provided as a convenience to easily implement basic multi-selection.\n - Iterate selection with 'None* it = None; ImGuiID id; while (selection.GetNextSelectedItem(&it, &id)) { ... }'\n   Or you can check 'if (Contains(id)) { ... }' for each possible object if their number is not too high to iterate.\n - USING THIS IS NOT MANDATORY. This is only a helper and not a required API.\n To store a multi-selection, in your application you could:\n - Use this helper as a convenience. We use our simple key->value ImGuiStorage as a std::set<ImGuiID> replacement.\n - Use your own external storage: e.g. std::set<MyObjectId>, std::vector<MyObjectId>, interval trees, intrusively stored selection etc.\n In ImGuiSelectionBasicStorage we:\n - always use indices in the multi-selection API (passed to SetNextItemSelectionUserData(), retrieved in ImGuiMultiSelectIO)\n - use the AdapterIndexToStorageId() indirection layer to abstract how persistent selection data is derived from an index.\n - use decently optimized logic to allow queries and insertion of very large selection sets.\n - do not preserve selection order.\n Many combinations are possible depending on how you prefer to store your items and how you prefer to store your selection.\n Large applications are likely to eventually want to get rid of this indirection layer and do their own thing.\n See https://github.com/ocornut/imgui/wiki/Multi-Select for details and pseudo-code using this helper.")
            ...
            .def("contains", [](const ImGuiSelectionBasicStorage &self, ImGuiID id) -> bool
                 {
                ...
                return Contains_adapt_force_lambda(id); }, nb::arg("id_"), "Query if an item id is in selection.")
            .def("clear", &ImGuiSelectionBasicStorage::Clear, "Clear selection")
            .def("swap", &ImGuiSelectionBasicStorage::Swap, nb::arg("r"), "Swap two selections")
            .def("set_item_selected", &ImGuiSelectionBasicStorage::SetItemSelected, nb::arg("id_"), nb::arg("selected"), "Add/remove an item from selection (generally done by ApplyRequests() function)")
            .def("get_storage_id_from_index", &ImGuiSelectionBasicStorage::GetStorageIdFromIndex, nb::arg("idx"), "(private API)\n\n Convert index to item id based on provided adapter.");

    auto pyClassImGuiSelectionExternalStorage =
        nb::class_<ImGuiSelectionExternalStorage>(m, "SelectionExternalStorage", " Optional helper to apply multi-selection requests to existing randomly accessible storage.\n Convenient if you want to quickly wire multi-select API on e.g. an array of bool or items storing their own selection state.")
    ...
    auto pyClassImDrawCmd =
        nb::class_<ImDrawCmd>(m, "ImDrawCmd", " Typically, 1 command = 1 GPU draw call (unless command is a callback)\n - VtxOffset: When 'io.BackendFlags & ImGuiBackendFlags_RendererHasVtxOffset' is enabled,\n   this fields allow us to render meshes larger than 64K vertices while keeping 16-bit indices.\n   Backends made for <1.71. will typically ignore the VtxOffset fields.\n - The ClipRect/TextureId/VtxOffset fields must be contiguous as we memcmp() them together (this is asserted for).")
    ...
    auto pyClassImDrawVert =
        nb::class_<ImDrawVert>(m, "ImDrawVert", "")
            ...
            if (uv.has_value())
                ...
                r->uv = ImVec2();
            r->col = col; }, nb::arg("pos") = nb::none(), nb::arg("uv") = nb::none(), nb::arg("col") = ImU32())
    ...
    auto pyClassImDrawCmdHeader =
        nb::class_<ImDrawCmdHeader>(m, "ImDrawCmdHeader", "[Internal] For use by ImDrawList")
            ...
            if (TextureId.has_value())
                ...
                r->TextureId = ImTextureID(); }, nb::arg("clip_rect") = nb::none(), nb::arg("texture_id") = nb::none())
    ...
    auto pyClassImDrawChannel =
        nb::class_<ImDrawChannel>(m, "ImDrawChannel", "[Internal] For use by ImDrawListSplitter")
            ...
            if (_IdxBuffer.has_value())
                ...
                r->_IdxBuffer = ImVector<ImDrawIdx>(); }, nb::arg("_cmd_buffer") = nb::none(), nb::arg("_idx_buffer") = nb::none())
            .def_rw("_cmd_buffer", &ImDrawChannel::_CmdBuffer, "")
            .def_rw("_idx_buffer", &ImDrawChannel::_IdxBuffer, "");

    auto pyClassImDrawListSplitter =
        nb::class_<ImDrawListSplitter>(m, "ImDrawListSplitter", " Split/Merge functions are used to split the draw list into different layers which can be drawn into out of order.\n This is used by the Columns/Tables API, so items of each column can be batched together in a same draw call.")
    ...
    auto pyClassImDrawList =
        nb::class_<ImDrawList>(m, "ImDrawList", " Draw command list\n This is the low-level list of polygons that ImGui:: functions are filling. At the end of the frame,\n all command lists are passed to your ImGuiIO::RenderDrawListFn function for rendering.\n Each dear imgui window contains its own ImDrawList. You can use ImGui::GetWindowDrawList() to\n access the current window draw list and draw custom primitives.\n You can interleave normal ImGui:: calls and adding primitives to the current draw list.\n In single viewport mode, top-left is == GetMainViewport()->Pos (generally 0,0), bottom-right is == GetMainViewport()->Pos+Size (generally io.DisplaySize).\n You are totally free to apply whatever transformation matrix you want to the data (depending on the use of the transformation you may want to apply it to ClipRect as well!)\n Important: Primitives are always added to the list and not culled (culling is done at higher-level by ImGui:: functions), if you use this API a lot consider coarse culling your drawn objects.")
            ...
            .def("add_text", [](ImDrawList &self, const ImVec2 &pos, ImU32 col, const char *text_begin, std::optional<std::string> text_end = std::nullopt)
                 {
                ...
                AddText_adapt_const_char_pointer_with_default_null(pos, col, text_begin, text_end); }, nb::arg("pos"), nb::arg("col"), nb::arg("text_begin"), nb::arg("text_end") = nb::none())
            .def("add_text", [](ImDrawList &self, ImFont *font, float font_size, const ImVec2 &pos, ImU32 col, const char *text_begin, std::optional<std::string> text_end = std::nullopt, float wrap_width = 0.0f, const ImVec4 *cpu_fine_clip_rect = NULL)
                 {
                ...
                AddText_adapt_const_char_pointer_with_default_null(font, font_size, pos, col, text_begin, text_end, wrap_width, cpu_fine_clip_rect); }, nb::arg("font"), nb::arg("font_size"), nb::arg("pos"), nb::arg("col"), nb::arg("text_begin"), nb::arg("text_end") = nb::none(), nb::arg("wrap_width") = 0.0f, nb::arg("cpu_fine_clip_rect") = nb::none())
            .def("add_bezier_cubic", &ImDrawList::AddBezierCubic, nb::arg("p1"), nb::arg("p2"), nb::arg("p3"), nb::arg("p4"), nb::arg("col"), nb::arg("thickness"), nb::arg("num_segments") = 0, "Cubic Bezier (4 control points)")
            .def("add_bezier_quadratic", &ImDrawList::AddBezierQuadratic, nb::arg("p1"), nb::arg("p2"), nb::arg("p3"), nb::arg("col"), nb::arg("thickness"), nb::arg("num_segments") = 0)
            // #ifdef IMGUI_BUNDLE_PYTHON_API
            //
            .def("add_polyline", nb::overload_cast<const std::vector<ImVec2> &, ImU32, ImDrawFlags, float>(&ImDrawList::AddPolyline), nb::arg("points"), nb::arg("col"), nb::arg("flags"), nb::arg("thickness"))
            .def("add_convex_poly_filled", nb::overload_cast<const std::vector<ImVec2> &, ImU32>(&ImDrawList::AddConvexPolyFilled), nb::arg("points"), nb::arg("col"))
            .def("add_concave_poly_filled", nb::overload_cast<const std::vector<ImVec2> &, ImU32>(&ImDrawList::AddConcavePolyFilled), nb::arg("points"), nb::arg("col"))
            // #endif
            //
            .def("add_image", [](ImDrawList &self, ImTextureID user_texture_id, const ImVec2 &p_min, const ImVec2 &p_max, const std::optional<const ImVec2> &uv_min = std::nullopt, const std::optional<const ImVec2> &uv_max = std::nullopt, ImU32 col = IM_COL32_WHITE)
                 {
                ...
                AddImage_adapt_mutable_param_with_default_value(user_texture_id, p_min, p_max, uv_min, uv_max, col); }, nb::arg("user_texture_id"), nb::arg("p_min"), nb::arg("p_max"), nb::arg("uv_min") = nb::none(), nb::arg("uv_max") = nb::none(), nb::arg("col") = IM_COL32_WHITE, "---\nPython bindings defaults:\n    If any of the params below is None, then its default value below will be used:\n        uv_min: ImVec2(0, 0)\n        uv_max: ImVec2(1, 1)")
            .def("add_image_quad", [](ImDrawList &self, ImTextureID user_texture_id, const ImVec2 &p1, const ImVec2 &p2, const ImVec2 &p3, const ImVec2 &p4, const std::optional<const ImVec2> &uv1 = std::nullopt, const std::optional<const ImVec2> &uv2 = std::nullopt, const std::optional<const ImVec2> &uv3 = std::nullopt, const std::optional<const ImVec2> &uv4 = std::nullopt, ImU32 col = IM_COL32_WHITE)
                 {
                ...
                AddImageQuad_adapt_mutable_param_with_default_value(user_texture_id, p1, p2, p3, p4, uv1, uv2, uv3, uv4, col); }, nb::arg("user_texture_id"), nb::arg("p1"), nb::arg("p2"), nb::arg("p3"), nb::arg("p4"), nb::arg("uv1") = nb::none(), nb::arg("uv2") = nb::none(), nb::arg("uv3") = nb::none(), nb::arg("uv4") = nb::none(), nb::arg("col") = IM_COL32_WHITE, "---\nPython bindings defaults:\n    If any of the params below is None, then its default value below will be used:\n        uv1: ImVec2(0, 0)\n        uv2: ImVec2(1, 0)\n        uv3: ImVec2(1, 1)\n        uv4: ImVec2(0, 1)")
            .def("add_image_rounded", &ImDrawList::AddImageRounded, nb::arg("user_texture_id"), nb::arg("p_min"), nb::arg("p_max"), nb::arg("uv_min"), nb::arg("uv_max"), nb::arg("col"), nb::arg("rounding"), nb::arg("flags") = 0)
            .def("path_clear", &ImDrawList::PathClear, "(private API)")
            .def("path_line_to", &ImDrawList::PathLineTo, nb::arg("pos"), "(private API)")
            .def("path_line_to_merge_duplicate", &ImDrawList::PathLineToMergeDuplicate, nb::arg("pos"), "(private API)")
            .def("path_fill_convex", &ImDrawList::PathFillConvex, nb::arg("col"), "(private API)")
            .def("path_fill_concave", &ImDrawList::PathFillConcave, nb::arg("col"), "(private API)")
            .def("path_stroke", &ImDrawList::PathStroke, nb::arg("col"), nb::arg("flags") = 0, nb::arg("thickness") = 1.0f, "(private API)")
            .def("path_arc_to", &ImDrawList::PathArcTo, nb::arg("center"), nb::arg("radius"), nb::arg("a_min"), nb::arg("a_max"), nb::arg("num_segments") = 0)
            .def("path_arc_to_fast", &ImDrawList::PathArcToFast, nb::arg("center"), nb::arg("radius"), nb::arg("a_min_of_12"), nb::arg("a_max_of_12"), "Use precomputed angles for a 12 steps circle")
            .def("path_elliptical_arc_to", &ImDrawList::PathEllipticalArcTo, nb::arg("center"), nb::arg("radius"), nb::arg("rot"), nb::arg("a_min"), nb::arg("a_max"), nb::arg("num_segments") = 0, "Ellipse")
            .def("path_bezier_cubic_curve_to", &ImDrawList::PathBezierCubicCurveTo, nb::arg("p2"), nb::arg("p3"), nb::arg("p4"), nb::arg("num_segments") = 0, "Cubic Bezier (4 control points)")
            .def("path_bezier_quadratic_curve_to", &ImDrawList::PathBezierQuadraticCurveTo, nb::arg("p2"), nb::arg("p3"), nb::arg("num_segments") = 0, "Quadratic Bezier (3 control points)")
            .def("path_rect", &ImDrawList::PathRect, nb::arg("rect_min"), nb::arg("rect_max"), nb::arg("rounding") = 0.0f, nb::arg("flags") = 0)
            ...
            .def("clone_output", &ImDrawList::CloneOutput, "Create a clone of the CmdBuffer/IdxBuffer/VtxBuffer.", nb::rv_policy::reference)
            .def("channels_split", &ImDrawList::ChannelsSplit, nb::arg("count"), "(private API)")
            .def("channels_merge", &ImDrawList::ChannelsMerge, "(private API)")
            .def("channels_set_current", &ImDrawList::ChannelsSetCurrent, nb::arg("n"), "(private API)")
            .def("prim_reserve", &ImDrawList::PrimReserve, nb::arg("idx_count"), nb::arg("vtx_count"))
            .def("prim_unreserve", &ImDrawList::PrimUnreserve, nb::arg("idx_count"), nb::arg("vtx_count"))
            .def("prim_rect", &ImDrawList::PrimRect, nb::arg("a"), nb::arg("b"), nb::arg("col"), "Axis aligned rectangle (composed of two triangles)")
            .def("prim_rect_uv", &ImDrawList::PrimRectUV, nb::arg("a"), nb::arg("b"), nb::arg("uv_a"), nb::arg("uv_b"), nb::arg("col"))
            .def("prim_quad_uv", &ImDrawList::PrimQuadUV, nb::arg("a"), nb::arg("b"), nb::arg("c"), nb::arg("d"), nb::arg("uv_a"), nb::arg("uv_b"), nb::arg("uv_c"), nb::arg("uv_d"), nb::arg("col"))
            .def("prim_write_vtx", &ImDrawList::PrimWriteVtx, nb::arg("pos"), nb::arg("uv"), nb::arg("col"), "(private API)")
            .def("prim_write_idx", &ImDrawList::PrimWriteIdx, nb::arg("idx"), "(private API)")
            .def("prim_vtx", &ImDrawList::PrimVtx, nb::arg("pos"), nb::arg("uv"), nb::arg("col"), "(private API)\n\n Write vertex with unique index")
            .def("_reset_for_new_frame", &ImDrawList::_ResetForNewFrame)
            .def("_clear_free_memory", &ImDrawList::_ClearFreeMemory)
            .def("_pop_unused_draw_cmd", &ImDrawList::_PopUnusedDrawCmd)
            .def("_try_merge_draw_cmds", &ImDrawList::_TryMergeDrawCmds)
            .def("_on_changed_clip_rect", &ImDrawList::_OnChangedClipRect)
            .def("_on_changed_texture_id", &ImDrawList::_OnChangedTextureID)
            .def("_on_changed_vtx_offset", &ImDrawList::_OnChangedVtxOffset)
            .def("_set_texture_id", &ImDrawList::_SetTextureID, nb::arg("texture_id"))
            .def("_calc_circle_auto_segment_count", &ImDrawList::_CalcCircleAutoSegmentCount, nb::arg("radius"))
            .def("_path_arc_to_fast_ex", &ImDrawList::_PathArcToFastEx, nb::arg("center"), nb::arg("radius"), nb::arg("a_min_sample"), nb::arg("a_max_sample"), nb::arg("a_step"))
            .def("_path_arc_to_n", &ImDrawList::_PathArcToN, nb::arg("center"), nb::arg("radius"), nb::arg("a_min"), nb::arg("a_max"), nb::arg("num_segments"));

    auto pyClassImDrawData =
        nb::class_<ImDrawData>(m, "ImDrawData", " All draw data to render a Dear ImGui frame\n (NB: the style and the naming convention here is a little inconsistent, we currently preserve them for backward compatibility purpose,\n as this is one of the oldest structure exposed by the library! Basically, ImDrawList == CmdList)")
    ...
    auto pyClassImFontConfig =
        nb::class_<ImFontConfig>(m, "ImFontConfig", "")
    ...
    auto pyClassImFontGlyph =
        nb::class_<ImFontGlyph>(m, "ImFontGlyph", " Hold rendering data for one glyph.\n (Note: some language parsers may fail to convert the 31+1 bitfield members, in this case maybe drop store a single u32 or we can rework this)")
            ...
            r->V0 = V0;
            r->U1 = U1;
            r->V1 = V1; }, nb::arg("advance_x") = float(), nb::arg("x0") = float(), nb::arg("y0") = float(), nb::arg("x1") = float(), nb::arg("y1") = float(), nb::arg("u0") = float(), nb::arg("v0") = float(), nb::arg("u1") = float(), nb::arg("v1") = float())
            ...
            // #ifdef IMGUI_BUNDLE_PYTHON_API
            //
            .def("is_colored", &ImFontGlyph::isColored, "(private API)")
            .def("is_visible", &ImFontGlyph::isVisible, "(private API)")
            .def("get_codepoint", &ImFontGlyph::getCodepoint, "(private API)")
        // #endif
        ;

    auto pyClassImFontGlyphRangesBuilder =
        nb::class_<ImFontGlyphRangesBuilder>(m, "ImFontGlyphRangesBuilder", " Helper to build glyph ranges from text/string data. Feed your application strings/characters to it then call BuildRanges().\n This is essentially a tightly packed of vector of 64k booleans = 8KB storage.")
            ...
            .def("add_char",
                 ...
                 nb::arg("c"),
                 "(private API)\n\n Add character")
            .def("add_text", [](ImFontGlyphRangesBuilder &self, const char *text, std::optional<std::string> text_end = std::nullopt)
                 {
                ...
                AddText_adapt_const_char_pointer_with_default_null(text, text_end); }, nb::arg("text"), nb::arg("text_end") = nb::none(), "Add string (each character of the UTF-8 string are added)")
            .def("build_ranges", &ImFontGlyphRangesBuilder::BuildRanges, nb::arg("out_ranges"), "Output new ranges");

    auto pyClassImFontAtlasCustomRect =
        nb::class_<ImFontAtlasCustomRect>(m, "ImFontAtlasCustomRect", "See ImFontAtlas::AddCustomRectXXX functions.")
    ...
    auto pyClassImFontAtlas =
        nb::class_<ImFontAtlas>(m, "ImFontAtlas", " Load and rasterize multiple TTF/OTF fonts into a same texture. The font atlas will build a single texture holding:\n  - One or more fonts.\n  - Custom graphics data needed to render the shapes needed by Dear ImGui.\n  - Mouse cursor shapes for software cursor rendering (unless setting 'Flags |= ImFontAtlasFlags_NoMouseCursors' in the font atlas).\n It is the user-code responsibility to setup/build the atlas, then upload the pixel data into a texture accessible by your graphics api.\n  - Optionally, call any of the AddFont*** functions. If you don't call any, the default font embedded in the code will be loaded for you.\n  - Call GetTexDataAsAlpha8() or GetTexDataAsRGBA32() to build and retrieve pixels data.\n  - Upload the pixels data into a texture within your graphics system (see imgui_impl_xxxx.cpp examples)\n  - Call SetTexID(my_tex_id); and pass the pointer/identifier to your texture in a format natural to your graphics API.\n    This value will be passed back to you during rendering to identify the texture. Read FAQ entry about ImTextureID for more details.\n Common pitfalls:\n - If you pass a 'glyph_ranges' array to AddFont*** functions, you need to make sure that your array persist up until the\n   atlas is build (when calling GetTexData*** or Build()). We only copy the pointer, not the data.\n - Important: By default, AddFontFromMemoryTTF() takes ownership of the data. Even though we are not writing to it, we will free the pointer on destruction.\n   You can set font_cfg->FontDataOwnedByAtlas=False to keep ownership of your data and it won't be freed,\n - Even though many functions are suffixed with \"TTF\", OTF data is supported just as well.\n - This is an old API and it is currently awkward for those and various other reasons! We will address them in the future!")
            ...
            .def("add_custom_rect_font_glyph", [](ImFontAtlas &self, ImFont *font, ImWchar id, int width, int height, float advance_x, const std::optional<const ImVec2> &offset = std::nullopt) -> int
                 {
                ...
                return AddCustomRectFontGlyph_adapt_mutable_param_with_default_value(font, id, width, height, advance_x, offset); }, nb::arg("font"), nb::arg("id_"), nb::arg("width"), nb::arg("height"), nb::arg("advance_x"), nb::arg("offset") = nb::none(), "---\nPython bindings defaults:\n    If offset is None, then its default value will be: ImVec2(0, 0)")
            .def("get_custom_rect_by_index", &ImFontAtlas::GetCustomRectByIndex, nb::arg("index"), "(private API)", nb::rv_policy::reference)
            .def("calc_custom_rect_uv", &ImFontAtlas::CalcCustomRectUV, nb::arg("rect"), nb::arg("out_uv_min"), nb::arg("out_uv_max"))
            .def("get_mouse_cursor_tex_data", &ImFontAtlas::GetMouseCursorTexData, nb::arg("cursor"), nb::arg("out_offset"), nb::arg("out_size"), nb::arg("out_uv_border"), nb::arg("out_uv_fill"))
    ...
    auto pyClassImFont =
        nb::class_<ImFont>(m, "ImFont", " Font runtime data and rendering\n ImFontAtlas automatically loads a default embedded font for you when you call GetTexDataAsAlpha8() or GetTexDataAsRGBA32().")
    ...
    auto pyClassImGuiViewport =
        nb::class_<ImGuiViewport>(m, "Viewport", " - Currently represents the Platform Window created by the application which is hosting our Dear ImGui windows.\n - With multi-viewport enabled, we extend this concept to have multiple active viewports.\n - In the future we will extend this concept further to also represent Platform Monitor and support a \"no main platform window\" operation mode.\n - About Main Area vs Work Area:\n   - Main Area = entire viewport.\n   - Work Area = entire viewport minus sections used by main menu bars (for platform windows), or by task bar (for platform monitor).\n   - Windows are generally trying to stay within the Work Area of their host viewport.")
    ...
    auto pyClassImGuiPlatformIO =
        nb::class_<ImGuiPlatformIO>(m, "PlatformIO", "Access via ImGui::GetPlatformIO()")
            .def(nb::init<>())
    ...
    auto pyClassImGuiPlatformMonitor =
        nb::class_<ImGuiPlatformMonitor>(m, "PlatformMonitor", " (Optional) This is required when enabling multi-viewport. Represent the bounds of each connected monitor/display and their DPI.\n We use this information for multiple DPI support + clamping the position of popups and tooltips so they don't straddle multiple monitors.")
    ...
    auto pyClassImGuiPlatformImeData =
        nb::class_<ImGuiPlatformImeData>(m, "PlatformImeData", "(Optional) Support for IME (Input Method Editor) via the platform_io.Platform_SetImeDataFn() function.")
    ...
    m.def("begin_horizontal", [](const char *str_id, const std::optional<const ImVec2> &size = std::nullopt, float align = -1.0f)
          {
            ...
            BeginHorizontal_adapt_mutable_param_with_default_value(str_id, size, align); }, nb::arg("str_id"), nb::arg("size") = nb::none(), nb::arg("align") = -1.0f, "---\nPython bindings defaults:\n    If size is None, then its default value will be: ImVec2(0, 0)");

    m.def("begin_horizontal", [](const void *ptr_id, const std::optional<const ImVec2> &size = std::nullopt, float align = -1.0f)
          {
            ...
            BeginHorizontal_adapt_mutable_param_with_default_value(ptr_id, size, align); }, nb::arg("ptr_id"), nb::arg("size") = nb::none(), nb::arg("align") = -1.0f, "---\nPython bindings defaults:\n    If size is None, then its default value will be: ImVec2(0, 0)");

    m.def("begin_horizontal", [](int id, const std::optional<const ImVec2> &size = std::nullopt, float align = -1)
          {
            ...
            BeginHorizontal_adapt_mutable_param_with_default_value(id, size, align); }, nb::arg("id_"), nb::arg("size") = nb::none(), nb::arg("align") = -1, "---\nPython bindings defaults:\n    If size is None, then its default value will be: ImVec2(0, 0)");

    m.def("end_horizontal",
          ImGui::EndHorizontal);

    m.def("begin_vertical", [](const char *str_id, const std::optional<const ImVec2> &size = std::nullopt, float align = -1.0f)
          {
            ...
            BeginVertical_adapt_mutable_param_with_default_value(str_id, size, align); }, nb::arg("str_id"), nb::arg("size") = nb::none(), nb::arg("align") = -1.0f, "---\nPython bindings defaults:\n    If size is None, then its default value will be: ImVec2(0, 0)");

    m.def("begin_vertical", [](const void *ptr_id, const std::optional<const ImVec2> &size = std::nullopt, float align = -1.0f)
          {
            ...
            BeginVertical_adapt_mutable_param_with_default_value(ptr_id, size, align); }, nb::arg("ptr_id"), nb::arg("size") = nb::none(), nb::arg("align") = -1.0f, "---\nPython bindings defaults:\n    If size is None, then its default value will be: ImVec2(0, 0)");

    m.def("begin_vertical", [](int id, const std::optional<const ImVec2> &size = std::nullopt, float align = -1)
          {
            ...
            BeginVertical_adapt_mutable_param_with_default_value(id, size, align); }, nb::arg("id_"), nb::arg("size") = nb::none(), nb::arg("align") = -1, "---\nPython bindings defaults:\n    If size is None, then its default value will be: ImVec2(0, 0)");
    ...
    m.def("input_text", [](const char *label, std::string str, ImGuiInputTextFlags flags = 0, ImGuiInputTextCallback callback = nullptr, void *user_data = nullptr) -> std::tuple<bool, std::string>
          {
            ...
            return InputText_adapt_modifiable_immutable_to_return(label, str, flags, callback, user_data); }, nb::arg("label"), nb::arg("str"), nb::arg("flags") = 0, nb::arg("callback") = nb::none(), nb::arg("user_data") = nb::none());

    m.def("input_text_multiline", [](const char *label, std::string str, const std::optional<const ImVec2> &size = std::nullopt, ImGuiInputTextFlags flags = 0, ImGuiInputTextCallback callback = nullptr, void *user_data = nullptr) -> std::tuple<bool, std::string>
          {
            ...
            return InputTextMultiline_adapt_modifiable_immutable_to_return(label, str, size, flags, callback, user_data); }, nb::arg("label"), nb::arg("str"), nb::arg("size") = nb::none(), nb::arg("flags") = 0, nb::arg("callback") = nb::none(), nb::arg("user_data") = nb::none(), "---\nPython bindings defaults:\n    If size is None, then its default value will be: ImVec2(0, 0)");

    m.def("input_text_with_hint", [](const char *label, const char *hint, std::string str, ImGuiInputTextFlags flags = 0, ImGuiInputTextCallback callback = nullptr, void *user_data = nullptr) -> std::tuple<bool, std::string>
          {
            ...
            return InputTextWithHint_adapt_modifiable_immutable_to_return(label, hint, str, flags, callback, user_data); }, nb::arg("label"), nb::arg("hint"), nb::arg("str"), nb::arg("flags") = 0, nb::arg("callback") = nb::none(), nb::arg("user_data") = nb::none());
    ////////////////////    </generated_from:imgui_stdlib.h>    ////////////////////

    ////////////////////    <generated_from:imgui_pywrappers.h>    ////////////////////
    auto pyClassImGuiPayload_PyId =
        nb::class_<ImGuiPayload_PyId>(m, "Payload_PyId", "")
            ...
            r->Type = Type; }, nb::arg("data_id") = nb::none(), nb::arg("type") = std::string())
...
void imgui_manual_binding(nb::module_ &m)
{
    ...
    pyClassImVec2.def("__iter__", [](const ImVec2 &self)
                      { return nb::make_iterator(nb::type<ImVec2>(), "iterator", &self.x, &self.x + 2); }, nb::keep_alive<0, 1>() /* Essential: keep object alive while iterator exists */
    );
    ...
    pyClassImVec4.def("__iter__", [](const ImVec4 &self)
                      { return nb::make_iterator(nb::type<ImVec4>(), "iterator", &self.x, &self.x + 4); }, nb::keep_alive<0, 1>() /* Essential: keep object alive while iterator exists */
    );
    ...
    pyClassImVec4.def("__init__", [](ImVec4 *self, ImVec4 imv)
                      {
        new (self) ImVec4();
        *self = ImVec4(imv.x, imv.y, imv.z, imv.w); }, nb::arg("xyzw"));
    ...
    pyClassImColor.def("__iter__", [](const ImColor &self)
                       { return nb::make_iterator(nb::type<ImColor>(), "iterator", &self.Value.x, &self.Value.x + 4); }, nb::keep_alive<0, 1>() /* Essential: keep object alive while iterator exists */
    );
